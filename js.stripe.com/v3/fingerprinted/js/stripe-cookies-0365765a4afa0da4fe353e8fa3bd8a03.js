...
(window.webpackChunkStripeJSinner = window.webpackChunkStripeJSinner || []).push([
    [7058], {
        47499: function(e, t, i) {
            ...
            function S(e, t) {
                if (t = t ? (0, w.Z)({}, Z, t) : Z, !e) return t.map ? {} : [];
                ...
                return Array.isArray(e) || (e = [e]), (t = t ? (0, w.Z)({}, Z, t) : Z).map ? e.filter(_).reduce((function(e, i) {
                    var r = b(i, t);
                    return e[r.name] = r, e
            ...
            var x, w = i(87462),
                ...
                I = C && (x = window.location.hostname, ["stripe.com", "stripe.dev", "stripe.global", "stripe.partners", "increment.com", "link.co", "link.com"].some((function(e) {
                ...
                N = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : C ? window.location.href : "";
                    return j(e) ? e.match(/(\.)?link.co([^m]|\b)/i) ? "https://link.co" : "https://link.com" : "https://stripe.com"
                },
                q = function(e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : C ? window.location.href : "",
                        i = N(t) + e;
                    if (!C || !window.URL || !window.URLSearchParams) return i;
                    var r = new URL(t),
                        n = new URL(i);
                ...
                D = function() {
                    ...
                    return f(e, [{
                        ...
                        key: "getAll",
                        value: function() {
                            return (0, w.Z)({}, this._permissions)
                        }
                    }, {
                        key: "toString",
                        value: function() {
                    ...
                    return f(e, [{
                        ...
                        value: function(e, t) {
                            if (!this.name.startsWith("__Host-")) {
                                ...
                                var r = e;
                                if (!r && C && (r = document.location.host), r && r.match("dev.stripe.me")) return ".dev.stripe.me";
                ...
                Y = S,
                X = b;
            K.parse = Y, K.parseString = X, K.splitCookiesString = function(e) {
                function t() {
                ...
                ee = function() {
                    ...
                    return f(e, [{
                            ...
                            return v(this, void 0, void 0, l().mark((function r() {
                                ...
                                return l().wrap((function(r) {
                                    for (;;) switch (r.prev = r.next) {
                                        ...
                                        case 22:
                                            return !C || n.name.startsWith("__Host-") || A(window.location.hostname, o) || M("The cookie ".concat(e, " will be set on the domain ").concat(o, ", which doesn't match ") + "the current domain (".concat(window.location.hostname, "). This will result in the ") + "cookie being silently ignored by the browser. Please check to ensure the domain(s) for the cookie are correct in cookies[-next].yaml, or visit go/cookies for more information."), s = void 0 === i.secure ? n.secure : i.secure, c = this._getCookieAttributes({
                                                domain: o,
                                                expires: a,
                                                secure: s,
                                                sameSite: n.sameSite
                        ...
                        value: function(e) {
                            ...
                            C && !A(window.location.hostname, t) && M("The cookie ".concat(e, " will be set on the domain ").concat(t, ", which doesn't match ") + "the current domain (".concat(window.location.hostname, "). This will result in the ") + "cookie being silently ignored by the browser. Please check to ensure the domain(s) for the cookie are correct in cookies[-next].yaml, or visit go/cookies for more information.");
                        ...
                        value: function() {
                            this._documentCookiePatched || (this._documentCookiePatched = function(e) {
                                if (!C) return R("You cannot patch document.cookie if you aren't in a browser."), !1;
                        ...
                        value: function() {
                            this._documentCookiePatched && (Q ? Object.defineProperty(document, "cookie", Q) : R("The document.cookie property has not been patched"), this._documentCookiePatched = !1)
                        }
                    }, {
