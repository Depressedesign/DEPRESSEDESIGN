var t = Object.defineProperty,
    ...
    o = (e, s, i) => s in e ? t(e, s, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: i
    }) : e[s] = i,
    n = (t, e, s) => new Promise(((i, a) => {
        var r = t => {
                try {
                    n(s.next(t))
                } catch (Mi) {
            ...
            n = t => t.done ? i(t.value) : Promise.resolve(t.value).then(r, o);
        ...
        if ("string" != typeof i && !Array.isArray(i))
            for (const e in i)
                if ("default" !== e && !(e in t)) {
                    ...
                    s && Object.defineProperty(t, e, s.get ? s : {
                        enumerable: !0,
                        get: () => i[e]
                    })
                }
...
var p = 1,
    ...
    f = 6378137,
    M = 6356752.314,
    w = .0066943799901413165,
    P = 484813681109536e-20,
    E = Math.PI / 2,
    v = .16666666666666666,
    S = .04722222222222222,
    x = .022156084656084655,
    G = 1e-10,
...
const R = {
    ...
    "us-in": {
        to_meter: .025400050800101
    },
    "us-yd": {
        to_meter: .914401828803658
    }
};
var O = /[\s_\-\/\(\)]/g;
...
function k(t, e) {
    if (t[e]) return t[e];
    for (var s, i = Object.keys(t), a = e.toLowerCase().replace(O, ""), r = -1; ++r < i.length;)
        if ((s = i[r]).toLowerCase().replace(O, "") === a) return t[s]
}
...
function T(t) {
    var e, s, i, a = {},
        ...
        o = {
            ...
            alpha: function(t) {
                a.alpha = parseFloat(t) * b
            },
            gamma: function(t) {
                a.rectified_grid_angle = parseFloat(t) * b
            },
            lonc: function(t) {
                a.longc = t * b
            },
            ...
            from_greenwich: function(t) {
                a.from_greenwich = t * b
            },
            pm: function(t) {
                var e = k(C, t);
                a.from_greenwich = (e || parseFloat(t)) * b
            },
            nadgrids: function(t) {
    ...
    for (e in r) s = r[e], e in o ? "function" == typeof(i = o[e]) ? i(s) : a[i] = s : a[e] = s;
    return "string" == typeof a.datumCode && "WGS84" !== a.datumCode && (a.datumCode = a.datumCode.toLowerCase()), a
}
class L {
    static getId(t) {
        const e = t.find((t => Array.isArray(t) && "ID" === t[0]));
        return e && e.length >= 3 ? {
            authority: e[1],
    ...
    static convertUnit(t, e = "unit") {
        ...
        const s = t[1],
            i = parseFloat(t[2]) || null,
            a = t.find((t => Array.isArray(t) && "ID" === t[0]));
        return {
            type: e,
            name: s,
            conversion_factor: i,
    ...
    static convertAxis(t) {
        ...
        } else s = t[2] ? t[2].toLowerCase() : "unknown";
        const a = t.find((t => Array.isArray(t) && "ORDER" === t[0])),
            r = a ? parseInt(a[1], 10) : null,
            o = t.find((t => Array.isArray(t) && ("LENGTHUNIT" === t[0] || "ANGLEUNIT" === t[0] || "SCALEUNIT" === t[0])));
        return {
            name: e,
            direction: s,
            unit: this.convertUnit(o),
            order: r
        }
    }
    static extractAxes(t) {
        return t.filter((t => Array.isArray(t) && "AXIS" === t[0])).map((t => this.convertAxis(t))).sort(((t, e) => (t.order || 0) - (e.order || 0)))
    }
    static convert(t, e = {}) {
        switch (t[0]) {
            case "PROJCRS":
                e.type = "ProjectedCRS", e.name = t[1], e.base_crs = t.find((t => Array.isArray(t) && "BASEGEOGCRS" === t[0])) ? this.convert(t.find((t => Array.isArray(t) && "BASEGEOGCRS" === t[0]))) : null, e.conversion = t.find((t => Array.isArray(t) && "CONVERSION" === t[0])) ? this.convert(t.find((t => Array.isArray(t) && "CONVERSION" === t[0]))) : null;
                const s = t.find((t => Array.isArray(t) && "CS" === t[0]));
                s && (e.coordinate_system = {
                    type: s[1],
                    axis: this.extractAxes(t)
                });
                const i = t.find((t => Array.isArray(t) && "LENGTHUNIT" === t[0]));
                if (i) {
                    const t = this.convertUnit(i);
                    e.coordinate_system.unit = t
                }
                e.id = this.getId(t);
                break;
            case "BASEGEOGCRS":
            case "GEOGCRS":
                ...
                const a = t.find((t => Array.isArray(t) && ("DATUM" === t[0] || "ENSEMBLE" === t[0])));
                if (a) {
                    const s = this.convert(a);
                    "ENSEMBLE" === a[0] ? e.datum_ensemble = s : e.datum = s;
                    const i = t.find((t => Array.isArray(t) && "PRIMEM" === t[0]));
                    i && "Greenwich" !== i[1] && (s.prime_meridian = {
                        name: i[1],
                        longitude: parseFloat(i[2])
                    })
                }
                e.coordinate_system = {
                    type: "ellipsoidal",
                ...
                break;
            case "DATUM":
                e.type = "GeodeticReferenceFrame", e.name = t[1], e.ellipsoid = t.find((t => Array.isArray(t) && "ELLIPSOID" === t[0])) ? this.convert(t.find((t => Array.isArray(t) && "ELLIPSOID" === t[0]))) : null;
                break;
            case "ENSEMBLE":
                e.type = "DatumEnsemble", e.name = t[1], e.members = t.filter((t => Array.isArray(t) && "MEMBER" === t[0])).map((t => ({
                    type: "DatumEnsembleMember",
                    name: t[1],
                    id: this.getId(t)
                })));
                const r = t.find((t => Array.isArray(t) && "ENSEMBLEACCURACY" === t[0]));
                r && (e.accuracy = parseFloat(r[1]));
                const o = t.find((t => Array.isArray(t) && "ELLIPSOID" === t[0]));
                o && (e.ellipsoid = this.convert(o)), e.id = this.getId(t);
                break;
            case "ELLIPSOID":
                e.type = "Ellipsoid", e.name = t[1], e.semi_major_axis = parseFloat(t[2]), e.inverse_flattening = parseFloat(t[3]), t.find((t => Array.isArray(t) && "LENGTHUNIT" === t[0])) && this.convert(t.find((t => Array.isArray(t) && "LENGTHUNIT" === t[0])), e);
                break;
            case "CONVERSION":
                e.type = "Conversion", e.name = t[1], e.method = t.find((t => Array.isArray(t) && "METHOD" === t[0])) ? this.convert(t.find((t => Array.isArray(t) && "METHOD" === t[0]))) : null, e.parameters = t.filter((t => Array.isArray(t) && "PARAMETER" === t[0])).map((t => this.convert(t)));
                break;
            case "METHOD":
                e.type = "Method", e.name = t[1], e.id = this.getId(t);
                break;
            case "PARAMETER":
                e.type = "Parameter", e.name = t[1], e.value = parseFloat(t[2]), e.unit = this.convertUnit(t.find((t => Array.isArray(t) && ("LENGTHUNIT" === t[0] || "ANGLEUNIT" === t[0] || "SCALEUNIT" === t[0])))), e.id = this.getId(t);
                break;
            case "BOUNDCRS":
                e.type = "BoundCRS";
                ...
                if (n) {
                    ...
                    e.source_crs = t ? this.convert(t) : null
                }
                const h = t.find((t => Array.isArray(t) && "TARGETCRS" === t[0]));
                if (h) {
                    const t = h.find((t => Array.isArray(t)));
                    e.target_crs = t ? this.convert(t) : null
                }
                const l = t.find((t => Array.isArray(t) && "ABRIDGEDTRANSFORMATION" === t[0]));
                e.transformation = l ? this.convert(l) : null;
                break;
            case "ABRIDGEDTRANSFORMATION":
                if (e.type = "Transformation", e.name = t[1], e.method = t.find((t => Array.isArray(t) && "METHOD" === t[0])) ? this.convert(t.find((t => Array.isArray(t) && "METHOD" === t[0]))) : null, e.parameters = t.filter((t => Array.isArray(t) && ("PARAMETER" === t[0] || "PARAMETERFILE" === t[0]))).map((t => "PARAMETER" === t[0] ? this.convert(t) : "PARAMETERFILE" === t[0] ? {
                        name: t[1],
                        value: t[2],
                        id: {
                            authority: "EPSG",
                    ...
                    } : void 0)), 7 === e.parameters.length) {
                    const t = e.parameters[6];
                    "Scale difference" === t.name && (t.value = Math.round(1e12 * (t.value - 1)) / 1e6)
                }
                e.id = this.getId(t);
                break;
            case "AXIS":
                e.coordinate_system || (e.coordinate_system = {
                    type: "unspecified",
                    axis: []
                }), e.coordinate_system.axis.push(this.convertAxis(t));
                break;
            case "LENGTHUNIT":
                const u = this.convertUnit(t, "LinearUnit");
                e.coordinate_system && e.coordinate_system.axis && e.coordinate_system.axis.forEach((t => {
                    t.unit || (t.unit = u)
                })), u.conversion_factor && 1 !== u.conversion_factor && e.semi_major_axis && (e.semi_major_axis = {
...
class j extends L {
    static convert(t, e = {}) {
        return super.convert(t, e), e.coordinate_system && "Cartesian" === e.coordinate_system.subtype && delete e.coordinate_system, e.usage && delete e.usage, e
    }
}
class q extends L {
    static convert(t, e = {}) {
        ...
        const i = t.find((t => Array.isArray(t) && "USAGE" === t[0]));
        if (i) {
            const t = i.find((t => Array.isArray(t) && "SCOPE" === t[0])),
                s = i.find((t => Array.isArray(t) && "AREA" === t[0])),
                a = i.find((t => Array.isArray(t) && "BBOX" === t[0]));
            e.usage = {}, t && (e.usage.scope = t[1]), s && (e.usage.area = s[1]), a && (e.usage.bbox = a.slice(1))
        }
        return e
    }
}
...
function Q(t) {
    ...
    this.text = t.trim(), this.level = 0, this.place = 0, this.root = null, this.stack = [], this.currentObject = null, this.state = U
}

function J(t, e, s) {
    Array.isArray(e) && (s.unshift(e), e = null);
    var i = e ? {} : t,
...
function X(t, e) {
    if (Array.isArray(t)) {
        var s = t.shift();
        if ("PARAMETER" === s && (s = t.shift()), 1 === t.length) return Array.isArray(t[0]) ? (e[s] = {}, void X(t[0], e[s])) : void(e[s] = t[0]);
        if (t.length)
            if ("TOWGS84" !== s) {
                if ("AXIS" === s) return s in e || (e[s] = []), void e[s].push(t);
                var i;
                switch (Array.isArray(s) || (e[s] = {}), s) {
                    case "UNIT":
                    case "PRIMEM":
                    case "VERT_DATUM":
                        return e[s] = {
                    ...
                    case "VERTCRS":
                    case "VERTICALCRS":
                        return t[0] = ["name", t[0]], void J(e, s, t);
                    case "COMPD_CS":
                    case "COMPOUNDCRS":
                    case "FITTED_CS":
                    case "PROJECTEDCRS":
                    ...
                    case "ENGCRS":
                    case "ENGINEERINGCRS":
                        return t[0] = ["name", t[0]], J(e, s, t), void(e[s].type = s);
                    default:
                        for (i = -1; ++i < t.length;)
                            if (!Array.isArray(t[i])) return X(t, e[s]);
                        return J(e, s, t)
                }
            } else e[s] = t;
        else e[s] = !0
...
Q.prototype.readCharicter = function() {
    ...
    if (W.test(t)) return this.word = this.word.trim(), void this.afterItem(t);
    throw new Error("havn't handled \"" + t + '" in afterquote yet, index ' + this.place)
}, Q.prototype.afterItem = function(t) {
    return "," === t ? (null !== this.word && this.currentObject.push(this.word), this.word = null, void(this.state = U)) : "]" === t ? (this.level--, null !== this.word && (this.currentObject.push(this.word), this.word = null), this.state = U, this.currentObject = this.stack.pop(), void(this.currentObject || (this.state = -1))) : void 0
}, Q.prototype.number = function(t) {
    if (!K.test(t)) {
        if (W.test(t)) return this.word = parseFloat(this.word), void this.afterItem(t);
    ...
    if (H.test(t)) this.word += t;
    else {
        if ("[" === t) {
            var e = [];
            return e.push(this.word), this.level++, null === this.root ? this.root = e : this.currentObject.push(e), this.stack.push(this.currentObject), this.currentObject = e, void(this.state = U)
        }
        if (!W.test(t)) throw new Error("havn't handled \"" + t + '" in keyword yet, index ' + this.place);
        this.afterItem(t)
    }
}, Q.prototype.neutral = function(t) {
    if (z.test(t)) return this.word = t, void(this.state = 2);
    if ('"' === t) return this.word = "", void(this.state = 4);
    if (K.test(t)) return this.word = t, void(this.state = 3);
    if (!W.test(t)) throw new Error("havn't handled \"" + t + '" in neutral yet, index ' + this.place);
    this.afterItem(t)
...
function Y(t) {
    ...
    t.long0 || !t.longc || "albers conic equal area" !== e && "lambert azimuthal equal area" !== e || (t.long0 = t.longc), t.lat_ts || !t.lat1 || "stereographic south pole" !== e && "polar stereographic (variant b)" !== e ? t.lat_ts || !t.lat0 || "polar stereographic" !== e && "polar stereographic (variant a)" !== e || (t.lat_ts = t.lat0, t.lat0 = Z(t.lat0 > 0 ? 90 : -90), delete t.lat1) : (t.lat0 = Z(t.lat1 > 0 ? 90 : -90), t.lat_ts = t.lat1, delete t.lat1)
}
...
function $(t) {
    ...
    return "string" == typeof t ? (e.units = t.toLowerCase(), "metre" === e.units && (e.units = "meter"), "meter" === e.units && (e.to_meter = 1)) : t && t.name && (e.units = t.name.toLowerCase(), "metre" === e.units && (e.units = "meter"), e.to_meter = t.conversion_factor), e
}
...
function et(t, e) {
    t.ellipsoid.radius ? (e.a = t.ellipsoid.radius, e.rf = 0) : (e.a = tt(t.ellipsoid.semi_major_axis), void 0 !== t.ellipsoid.inverse_flattening ? e.rf = t.ellipsoid.inverse_flattening : void 0 !== t.ellipsoid.semi_major_axis && void 0 !== t.ellipsoid.semi_minor_axis && (e.rf = e.a / (e.a - tt(t.ellipsoid.semi_minor_axis))))
}

function st(t, e = {}) {
    return t && "object" == typeof t ? "BoundCRS" === t.type ? (st(t.source_crs, e), t.transformation && (t.transformation.method && "NTv2" === t.transformation.method.name ? e.nadgrids = t.transformation.parameters[0].value : e.datum_params = t.transformation.parameters.map((t => t.value))), e) : (Object.keys(t).forEach((s => {
        const i = t[s];
        if (null !== i) switch (s) {
            case "name":
                if (e.srsCode) break;
                e.name = i, e.srsCode = i;
                break;
            case "type":
                "GeographicCRS" === i ? e.projName = "longlat" : "ProjectedCRS" === i && t.conversion && t.conversion.method && (e.projName = t.conversion.method.name);
                break;
            case "datum":
            case "datum_ensemble":
                i.ellipsoid && (e.ellps = i.ellipsoid.name, et(i, e)), i.prime_meridian && (e.from_greenwich = i.prime_meridian.longitude * Math.PI / 180);
                break;
            case "ellipsoid":
                e.ellps = i.name, et(i, e);
                break;
            case "prime_meridian":
                e.long0 = (i.longitude || 0) * Math.PI / 180;
                break;
            case "coordinate_system":
                if (i.axis)
                    if (e.axis = i.axis.map((t => {
                            const e = t.direction;
                            if ("east" === e) return "e";
                            if ("north" === e) return "n";
                            if ("west" === e) return "w";
                        ...
                        e.units = t, e.to_meter = s
                    } else if (i.axis[0] && i.axis[0].unit) {
                    const {
                        units: t,
                        to_meter: s
                    } = $(i.axis[0].unit);
                ...
                break;
            case "id":
                i.authority && i.code && (e.title = i.authority + ":" + i.code);
                break;
            case "conversion":
                i.method && i.method.name && (e.projName = i.method.name), i.parameters && i.parameters.forEach((t => {
                    const s = t.name.toLowerCase().replace(/\s+/g, "_"),
                        i = t.value;
                    t.unit && t.unit.conversion_factor ? e[s] = i * t.unit.conversion_factor : "degree" === t.unit ? e[s] = i * Math.PI / 180 : e[s] = i
                }));
                break;
            case "unit":
                i.name && (e.units = i.name.toLowerCase(), "metre" === e.units && (e.units = "meter")), i.conversion_factor && (e.to_meter = i.conversion_factor);
                break;
            case "base_crs":
                st(i, e), e.datumCode = i.id ? i.id.authority + "_" + i.id.code : i.name
        }
    })), void 0 !== e.latitude_of_false_origin && (e.lat0 = e.latitude_of_false_origin), void 0 !== e.longitude_of_false_origin && (e.long0 = e.longitude_of_false_origin), void 0 !== e.latitude_of_standard_parallel && (e.lat0 = e.latitude_of_standard_parallel, e.lat1 = e.latitude_of_standard_parallel), void 0 !== e.latitude_of_1st_standard_parallel && (e.lat1 = e.latitude_of_1st_standard_parallel), void 0 !== e.latitude_of_2nd_standard_parallel && (e.lat2 = e.latitude_of_2nd_standard_parallel), void 0 !== e.latitude_of_projection_centre && (e.lat0 = e.latitude_of_projection_centre), void 0 !== e.longitude_of_projection_centre && (e.longc = e.longitude_of_projection_centre), void 0 !== e.easting_at_false_origin && (e.x0 = e.easting_at_false_origin), void 0 !== e.northing_at_false_origin && (e.y0 = e.northing_at_false_origin), void 0 !== e.latitude_of_natural_origin && (e.lat0 = e.latitude_of_natural_origin), void 0 !== e.longitude_of_natural_origin && (e.long0 = e.longitude_of_natural_origin), void 0 !== e.longitude_of_origin && (e.long0 = e.longitude_of_origin), void 0 !== e.false_easting && (e.x0 = e.false_easting), e.easting_at_projection_centre && (e.x0 = e.easting_at_projection_centre), void 0 !== e.false_northing && (e.y0 = e.false_northing), e.northing_at_projection_centre && (e.y0 = e.northing_at_projection_centre), void 0 !== e.standard_parallel_1 && (e.lat1 = e.standard_parallel_1), void 0 !== e.standard_parallel_2 && (e.lat2 = e.standard_parallel_2), void 0 !== e.scale_factor_at_natural_origin && (e.k0 = e.scale_factor_at_natural_origin), void 0 !== e.scale_factor_at_projection_centre && (e.k0 = e.scale_factor_at_projection_centre), void 0 !== e.scale_factor_on_pseudo_standard_parallel && (e.k0 = e.scale_factor_on_pseudo_standard_parallel), void 0 !== e.azimuth && (e.alpha = e.azimuth), void 0 !== e.azimuth_at_projection_centre && (e.alpha = e.azimuth_at_projection_centre), e.angle_from_rectified_to_skew_grid && (e.rectified_grid_angle = e.angle_from_rectified_to_skew_grid), Y(e), e) : t
}
var it = ["PROJECTEDCRS", "PROJCRS", "GEOGCS", "GEOCCS", "PROJCS", "LOCAL_CS", "GEODCRS", "GEODETICCRS", "GEODETICDATUM", "ENGCRS", "ENGINEERINGCRS"];

function at(t) {
    for (var e = Object.keys(t), s = 0, i = e.length; s < i; ++s) {
        var a = e[s]; - 1 !== it.indexOf(a) && rt(t[a]), "object" == typeof t[a] && at(t[a])
    }
}
...
function rt(t) {
    ...
    if ("GEOGCS" === t.type ? t.projName = "longlat" : "LOCAL_CS" === t.type ? (t.projName = "identity", t.local = !0) : "object" == typeof t.PROJECTION ? t.projName = Object.keys(t.PROJECTION)[0] : t.projName = t.PROJECTION, t.AXIS) {
        for (var s = "", i = 0, a = t.AXIS.length; i < a; ++i) {
            var r = [t.AXIS[i][0].toLowerCase(), t.AXIS[i][1].toLowerCase()]; - 1 !== r[0].indexOf("north") || ("y" === r[0] || "lat" === r[0]) && "north" === r[1] ? s += "n" : -1 !== r[0].indexOf("south") || ("y" === r[0] || "lat" === r[0]) && "south" === r[1] ? s += "s" : -1 !== r[0].indexOf("east") || ("x" === r[0] || "lon" === r[0]) && "east" === r[1] ? s += "e" : -1 === r[0].indexOf("west") && ("x" !== r[0] && "lon" !== r[0] || "west" !== r[1]) || (s += "w")
        }
        2 === s.length && (s += "u"), 3 === s.length && (t.axis = s)
    }
    ...
    [
        ...
        return s = t, a = (i = e)[0], r = i[1], void(!(a in s) && r in s && (s[a] = s[r], 3 === i.length && (s[a] = i[2](s[a]))));
        var s, i, a, r
    })), Y(t)
}

function ot(t) {
    if ("object" == typeof t) return st(t);
    const e = function(t) {
    ...
    var s = new Q(t).output();
    if ("WKT2" === e) {
        return st(B(s))
    }
    var i = s[0],
        a = {};
    return X(s, a), at(a), a[i]
}
...
function nt(t) {
    ...
    if (2 === arguments.length) {
        var s = arguments[1];
        "string" == typeof s ? "+" === s.charAt(0) ? nt[t] = T(arguments[1]) : nt[t] = ot(arguments[1]) : nt[t] = s
    } else if (1 === arguments.length) {
        if (Array.isArray(t)) return t.map((function(t) {
            return Array.isArray(t) ? nt.apply(e, t) : nt(t)
        }));
        if ("string" == typeof t) {
            if (t in nt) return nt[t]
        } else "EPSG" in t ? nt["EPSG:" + t.EPSG] = t : "ESRI" in t ? nt["ESRI:" + t.ESRI] = t : "IAU2000" in t ? nt["IAU2000:" + t.IAU2000] = t : console.log(t);
        return
    }
}! function(t) {
    t("EPSG:4326", "+title=WGS 84 (long/lat) +proj=longlat +ellps=WGS84 +datum=WGS84 +units=degrees"), t("EPSG:4269", "+title=NAD83 (long/lat) +proj=longlat +a=6378137.0 +b=6356752.31414036 +ellps=GRS80 +datum=NAD83 +units=degrees"), t("EPSG:3857", "+title=WGS 84 / Pseudo-Mercator +proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +units=m +nadgrids=@null +no_defs");
    for (var e = 1; e <= 60; ++e) t("EPSG:" + (32600 + e), "+proj=utm +zone=" + e + " +datum=WGS84 +units=m"), t("EPSG:" + (32700 + e), "+proj=utm +zone=" + e + " +south +datum=WGS84 +units=m");
...
function lt(t) {
    ...
    if (function(t) {
        ...
        if (function(t) {
                ...
                if (e) {
                    var s = k(e, "epsg");
                    return s && ht.indexOf(s) > -1
                }
            }(e)) return nt["EPSG:3857"];
        var s = function(t) {
            var e = k(t, "extension");
            if (e) return k(e, "proj4")
        }(e);
        return s ? T(s) : e
    }
    return function(t) {
...
function ut(t, e) {
    var s, i;
    if (t = t || {}, !e) return t;
    for (i in e) void 0 !== (s = e[i]) && (t[i] = s);
    return t
}

function ct(t, e, s) {
    var i = t * e;
    return s / Math.sqrt(1 - i * i)
}
...
function pt(t) {
    return Math.abs(t) <= I ? t : t - yt(t) * F
}

function dt(t, e, s) {
    var i = t * s,
        a = .5 * t;
    return i = Math.pow((1 - i) / (1 + i), a), Math.tan(.5 * (E - e)) / i
}

function gt(t, e) {
    for (var s, i, a = .5 * t, r = E - 2 * Math.atan(e), o = 0; o <= 15; o++)
        if (s = t * Math.sin(r), r += i = E - 2 * Math.atan(e * Math.pow((1 - s) / (1 + s), a)) - r, Math.abs(i) <= 1e-10) return r;
    return -9999
}
...
var _t = [{
        init: function() {
            var t = this.b / this.a;
            this.es = 1 - t * t, "x0" in this || (this.x0 = 0), "y0" in this || (this.y0 = 0), this.e = Math.sqrt(this.es), this.lat_ts ? this.sphere ? this.k0 = Math.cos(this.lat_ts) : this.k0 = ct(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)) : this.k0 || (this.k ? this.k0 = this.k : this.k0 = 1)
        },
        forward: function(t) {
            var e, s, i = t.x,
                a = t.y;
            if (a * A > 90 && a * A < -90 && i * A > 180 && i * A < -180) return null;
            if (Math.abs(Math.abs(a) - E) <= G) return null;
            if (this.sphere) e = this.x0 + this.a * this.k0 * pt(i - this.long0), s = this.y0 + this.a * this.k0 * Math.log(Math.tan(N + .5 * a));
            else {
                var r = Math.sin(a),
                    o = dt(this.e, a, r);
                e = this.x0 + this.a * this.k0 * pt(i - this.long0), s = this.y0 - this.a * this.k0 * Math.log(o)
            }
            return t.x = e, t.y = s, t
        },
        inverse: function(t) {
            var e, s, i = t.x - this.x0,
                a = t.y - this.y0;
            if (this.sphere) s = E - 2 * Math.atan(Math.exp(-a / (this.a * this.k0)));
            else {
                var r = Math.exp(-a / (this.a * this.k0));
                if (-9999 === (s = gt(this.e, r))) return null
            }
            return e = pt(this.long0 + i / (this.a * this.k0)), t.x = e, t.y = s, t
        },
...
function wt(t, e) {
    var s = Mt.length;
    return t.names ? (Mt[s] = t, t.names.forEach((function(t) {
        ft[t.toLowerCase()] = s
...
const Et = {
    ...
    get: function(t) {
        if (!t) return !1;
        var e = t.toLowerCase();
        return void 0 !== ft[e] && Mt[ft[e]] || (e = Pt(e)) in ft && Mt[ft[e]] ? Mt[ft[e]] : void 0
    }
};
var vt = {
    MERIT: {
...
for (var Gt in xt) {
    var bt = xt[Gt];
    bt.datumName && (xt[bt.datumName] = bt)
}
var At = {};

function Nt(t, e) {
    return n(this, null, (function*() {
        for (var s = [], i = yield e.getImageCount(), a = i - 1; a >= 0; a--) {
            var r = yield e.getImage(a), o = yield r.readRasters(), n = [r.getWidth(), r.getHeight()], h = r.getBoundingBox().map(It), l = [r.fileDirectory.ModelPixelScale[0], r.fileDirectory.ModelPixelScale[1]].map(It), u = h[0] + (n[0] - 1) * l[0], c = h[3] - (n[1] - 1) * l[1], y = o[0], p = o[1], d = [];
            for (let t = n[1] - 1; t >= 0; t--)
                for (let e = n[0] - 1; e >= 0; e--) {
                    var g = t * n[0] + e;
                    d.push([-Ct(p[g]), Ct(y[g])])
                }
            s.push({
                del: l,
                lim: n,
...
function Rt(t, e, s) {
    return String.fromCharCode.apply(null, new Uint8Array(t.buffer.slice(e, s)))
}

function Ot(t) {
    return t.map((function(t) {
        return [Ct(t.longitudeShift), Ct(t.latitudeShift)]
    }))
}

function kt(t, e, s) {
    return {
        name: Rt(t, e + 8, e + 16).trim(),
        parent: Rt(t, e + 24, e + 24 + 8).trim(),
        lowerLatitude: t.getFloat64(e + 72, s),
        upperLatitude: t.getFloat64(e + 88, s),
        lowerLongitude: t.getFloat64(e + 104, s),
        upperLongitude: t.getFloat64(e + 120, s),
        latitudeInterval: t.getFloat64(e + 136, s),
        longitudeInterval: t.getFloat64(e + 152, s),
        gridNodeCount: t.getInt32(e + 168, s)
    }
}

function Tt(t, e, s, i, a) {
    var r = e + 176,
        o = 16;
    !1 === a && (o = 8);
    for (var n = [], h = 0; h < s.gridNodeCount; h++) {
        var l = {
            latitudeShift: t.getFloat32(r + h * o, i),
            longitudeShift: t.getFloat32(r + h * o + 4, i)
        };
        !1 !== a && (l.latitudeAccuracy = t.getFloat32(r + h * o + 8, i), l.longitudeAccuracy = t.getFloat32(r + h * o + 12, i)), n.push(l)
    }
    return n
}
...
function Lt(t, e) {
    ...
    this.forward = null, this.inverse = null, this.name, this.title, e = e || function(t) {
        if (t) throw t
    };
    var s = lt(t);
    if ("object" == typeof s) {
        var i = Lt.projections.get(s.projName);
        if (i) {
            if (s.datumCode && "none" !== s.datumCode) {
                var a = k(xt, s.datumCode);
            ...
            var r, o, n, h, l, u, c, y = function(t, e, s, i, a) {
                    if (!t) {
                        var r = k(vt, i);
                        r || (r = St), t = r.a, e = r.b, s = r.rf
                    }
                    return s && !e && (e = (1 - 1 / s) * t), (0 === s || Math.abs(t - e) < G) && (a = !0, e = t), {
                        a: t,
                        b: e,
                        rf: s,
                        sphere: a
                    }
                }(s.a, s.b, s.rf, s.ellps, s.sphere),
                f = (r = y.a, o = y.b, y.rf, n = s.R_A, u = ((h = r * r) - (l = o * o)) / h, c = 0, n ? (h = (r *= 1 - u * (v + u * (S + u * x))) * r, u = 0) : c = Math.sqrt(u), {
                    es: u,
                    e: c,
                    ep2: (h - l) / l
                }),
                M = function(t) {
                    return void 0 === t ? null : t.split(",").map(Ft)
                }(s.nadgrids),
                w = s.datum || function(t, e, s, i, a, r, o) {
                    var n = {};
                    return n.datum_type = void 0 === t || "none" === t ? _ : m, e && (n.datum_params = e.map(parseFloat), 0 === n.datum_params[0] && 0 === n.datum_params[1] && 0 === n.datum_params[2] || (n.datum_type = p), n.datum_params.length > 3 && (0 === n.datum_params[3] && 0 === n.datum_params[4] && 0 === n.datum_params[5] && 0 === n.datum_params[6] || (n.datum_type = d, n.datum_params[3] *= P, n.datum_params[4] *= P, n.datum_params[5] *= P, n.datum_params[6] = n.datum_params[6] / 1e6 + 1))), o && (n.datum_type = g, n.grids = o), n.a = s, n.b = i, n.es = a, n.ep2 = r, n
                }(s.datumCode, s.datum_params, y.a, y.b, f.es, f.ep2, M);
            ut(this, s), ut(this, i), this.a = y.a, this.b = y.b, this.rf = y.rf, this.sphere = y.sphere, this.es = f.es, this.e = f.e, this.ep2 = f.ep2, this.datum = w, "init" in this && "function" == typeof this.init && this.init(), e(null, this)
        } else e("Could not get projection name from: " + t)
    } else e("Could not parse to valid json: " + t)
}
...
function jt(t, e, s) {
    ...
    return n > Math.PI && (n -= 2 * Math.PI), a = Math.sin(h), o = Math.cos(h), r = a * a, {
        x: ((i = s / Math.sqrt(1 - e * r)) + l) * o * Math.cos(n),
        y: (i + l) * o * Math.sin(n),
        z: (i * (1 - e) + l) * a
    }
}
...
function qt(t, e, s, i) {
    var a, r, o, n, h, l, u, c, y, p, d, g, m, _, f, M = 1e-12,
        w = t.x,
        P = t.y,
        E = t.z ? t.z : 0;
    if (a = Math.sqrt(w * w + P * P), r = Math.sqrt(w * w + P * P + E * E), a / s < M) {
        if (_ = 0, r / s < M) return f = -i, {
            x: t.x,
            y: t.y,
            z: t.z
        }
    } else _ = Math.atan2(P, w);
    o = E / r, c = (n = a / r) * (1 - e) * (h = 1 / Math.sqrt(1 - e * (2 - e) * n * n)), y = o * h, m = 0;
    do {
        m++, l = e * (u = s / Math.sqrt(1 - e * y * y)) / (u + (f = a * c + E * y - u * (1 - e * y * y))), g = (d = o * (h = 1 / Math.sqrt(1 - l * (2 - l) * n * n))) * c - (p = n * (1 - l) * h) * y, c = p, y = d
    } while (g * g > 1e-24 && m < 30);
    return {
        x: _,
        y: Math.atan(d / Math.abs(p)),
        z: f
    }
}
...
function Ut(t, e, s) {
    ...
    if (t.datum_type === _ || e.datum_type === _) return s;
    var i = t.a,
        a = t.es;
    if (t.datum_type === g) {
        if (0 !== Dt(t, !1, s)) return;
        i = f, a = w
    }
    var r = e.a,
        o = e.b,
        n = e.es;
    if (e.datum_type === g && (r = f, o = M, n = w), a === n && i === r && !Bt(t.datum_type) && !Bt(e.datum_type)) return s;
    if ((s = jt(s, a, i), Bt(t.datum_type) && (s = function(t, e, s) {
            if (e === p) return {
                x: t.x + s[0],
                y: t.y + s[1],
                z: t.z + s[2]
            ...
            if (e === d) {
                var i = s[0],
                    ...
                    l = s[6];
                return {
                    x: l * (t.x - h * t.y + n * t.z) + i,
                    y: l * (h * t.x + t.y - o * t.z) + a,
                    z: l * (-n * t.x + o * t.y + t.z) + r
                }
            }
        }(s, t.datum_type, t.datum_params)), Bt(e.datum_type) && (s = function(t, e, s) {
            if (e === p) return {
                x: t.x - s[0],
                y: t.y - s[1],
                z: t.z - s[2]
        ...
        }(s, e.datum_type, e.datum_params)), s = qt(s, n, r, o), e.datum_type === g) && 0 !== Dt(e, !0, s)) return;
    return s
}
...
function Dt(t, e, s) {
    ...
    var i = {
        ...
        r = [];
    t: for (var o = 0; o < t.grids.length; o++) {
        var n = t.grids[o];
        ...
        if (null !== n.grid)
            for (var h = n.grid.subgrids, l = 0, u = h.length; l < u; l++) {
                var c = h[l],
                    y = (Math.abs(c.del[1]) + Math.abs(c.del[0])) / 1e4,
                    p = c.ll[0] - y,
                    d = c.ll[1] - y,
                    g = c.ll[0] + (c.lim[0] - 1) * c.del[0] + y,
                    m = c.ll[1] + (c.lim[1] - 1) * c.del[1] + y;
                if (!(d > i.y || p > i.x || m < i.y || g < i.x) && (a = zt(i, e, c), !isNaN(a.x))) break t
            } else if (n.mandatory) return console.log("Unable to find mandatory grid '" + n.name + "'"), -1
    }
    return isNaN(a.x) ? (console.log("Failed to find a grid shift table for location '" + -i.x * A + " " + i.y * A + " tried: '" + r + "'"), -1) : (s.x = -a.x, s.y = a.y, 0)
}
...
function zt(t, e, s) {
    ...
    a.x -= s.ll[0], a.y -= s.ll[1], a.x = pt(a.x - Math.PI) + Math.PI;
    var r = Ht(a, s);
    if (e) {
        if (isNaN(r.x)) return i;
        r.x = a.x - r.x, r.y = a.y - r.y;
        var o, n, h = 9;
        do {
            if (n = Ht(r, s), isNaN(n.x)) {
        ...
        } while (h-- && Math.abs(o.x) > 1e-12 && Math.abs(o.y) > 1e-12);
        if (h < 0) return console.log("Inverse grid shift iterator failed to converge."), i;
        i.x = pt(r.x + s.ll[0]), i.y = r.y + s.ll[1]
    } else isNaN(r.x) || (i.x = t.x + r.x, i.y = t.y + r.y);
    return i
}
...
function Ht(t, e) {
    ...
    if (a < 0 || a >= e.lim[0]) return h;
    if (r < 0 || r >= e.lim[1]) return h;
    s = r * e.lim[0] + a;
    var l = e.cvs[s][0],
        u = e.cvs[s][1];
    s++;
    ...
    var g = e.cvs[s][0],
        ...
        M = (1 - o) * (1 - n),
        w = (1 - o) * n;
    return h.x = M * l + f * c + w * g + _ * p, h.y = M * u + f * y + w * m + _ * d, h
}
...
function Wt(t, e, s) {
    var i, a, r, o = s.x,
        ...
        l = {};
    for (r = 0; r < 3; r++)
        if (!e || 2 !== r || void 0 !== s.z) switch (0 === r ? (i = o, a = -1 !== "ew".indexOf(t.axis[r]) ? "x" : "y") : 1 === r ? (i = n, a = -1 !== "ns".indexOf(t.axis[r]) ? "y" : "x") : (i = h, a = "z"), t.axis[r]) {
            case "e":
            case "n":
                l[a] = i;
                break;
...
function Jt(t, e, s, i) {
    var a, r = void 0 !== (s = Array.isArray(s) ? Kt(s) : {
        x: s.x,
        y: s.y,
        z: s.z,
        m: s.m
    ...
    if (function(t) {
            Qt(t.x), Qt(t.y)
        }(s), t.datum && e.datum && function(t, e) {
            return (t.datum.datum_type === p || t.datum.datum_type === d || t.datum.datum_type === g) && "WGS84" !== e.datumCode || (e.datum.datum_type === p || e.datum.datum_type === d || e.datum.datum_type === g) && "WGS84" !== t.datumCode
        }(t, e) && (s = Jt(t, a = new Lt("WGS84"), s, i), t = a), i && "enu" !== t.axis && (s = Wt(t, !1, s)), "longlat" === t.projName) s = {
        x: s.x * b,
        y: s.y * b,
        z: s.z || 0
    };
            ...
            y: s.y * t.to_meter,
            z: s.z || 0
        }), !(s = t.inverse(s))) return;
    if (t.from_greenwich && (s.x += t.from_greenwich), s = Ut(t.datum, e.datum, s)) return e.from_greenwich && (s = {
        x: s.x - e.from_greenwich,
        y: s.y,
        z: s.z || 0
    }), "longlat" === e.projName ? s = {
        x: s.x * A,
        y: s.y * A,
        z: s.z || 0
    } : (s = e.forward(s), e.to_meter && (s = {
        x: s.x / e.to_meter,
        y: s.y / e.to_meter,
        z: s.z || 0
    })), i && "enu" !== e.axis ? Wt(e, !0, s) : (s && !r && delete s.z, s)
}
Lt.projections = Et, Lt.projections.start();
var Xt = Lt("WGS84");

function Vt(t, e, s, i) {
    var a, r, o;
    return Array.isArray(s) ? (a = Jt(t, e, s, i) || {
        x: NaN,
        y: NaN
    }, s.length > 2 ? void 0 !== t.name && "geocent" === t.name || void 0 !== e.name && "geocent" === e.name ? "number" == typeof a.z ? [a.x, a.y, a.z].concat(s.slice(3)) : [a.x, a.y, s[2]].concat(s.slice(3)) : [a.x, a.y].concat(s.slice(2)) : [a.x, a.y]) : (r = Jt(t, e, s, i), 2 === (o = Object.keys(s)).length || o.forEach((function(i) {
...
function Zt(t) {
    return t instanceof Lt ? t : "object" == typeof t && "oProj" in t ? t.oProj : Lt(t)
}
var Yt = 6,
    $t = "AJSAJS",
    te = "AFAFAF",
...
function ne(t, e) {
    return e = e || 5,
        function(t, e) {
            var s = "00000" + t.easting,
                i = "00000" + t.northing;
            return t.zoneNumber + t.zoneLetter + (p = t.easting, d = t.northing, g = t.zoneNumber, m = pe(g), _ = Math.floor(p / 1e5), f = Math.floor(d / 1e5) % 20, a = _, r = f, o = m, n = o - 1, h = $t.charCodeAt(n), l = te.charCodeAt(n), u = h + a - 1, c = l + r, y = !1, u > re && (u = u - re + ee - 1, y = !0), (u === se || h < se && u > se || (u > se || h < se) && y) && u++, (u === ie || h < ie && u > ie || (u > ie || h < ie) && y) && ++u === se && u++, u > re && (u = u - re + ee - 1), c > ae ? (c = c - ae + ee - 1, y = !0) : y = !1, (c === se || l < se && c > se || (c > se || l < se) && y) && c++, (c === ie || l < ie && c > ie || (c > ie || l < ie) && y) && ++c === se && c++, c > ae && (c = c - ae + ee - 1), String.fromCharCode(u) + String.fromCharCode(c)) + s.substr(s.length - 5, e) + i.substr(i.length - 5, e);
            var a, r, o, n, h, l, u, c, y;
            var p, d, g, m, _, f
        }(function(t) {
            var e, s, i, a, r, o, n, h, l = t.lat,
                u = t.lon,
                c = 6378137,
                y = .00669438,
                p = .9996,
                d = le(l),
                g = le(u);
            h = Math.floor((u + 180) / 6) + 1, 180 === u && (h = 60);
            l >= 56 && l < 64 && u >= 3 && u < 12 && (h = 32);
            l >= 72 && l < 84 && (u >= 0 && u < 9 ? h = 31 : u >= 9 && u < 21 ? h = 33 : u >= 21 && u < 33 ? h = 35 : u >= 33 && u < 42 && (h = 37));
            n = le(6 * (h - 1) - 180 + 3), e = y / (1 - y), s = c / Math.sqrt(1 - y * Math.sin(d) * Math.sin(d)), i = Math.tan(d) * Math.tan(d), a = e * Math.cos(d) * Math.cos(d), r = Math.cos(d) * (g - n), o = c * ((1 - y / 4 - 3 * y * y / 64 - 5 * y * y * y / 256) * d - (3 * y / 8 + 3 * y * y / 32 + 45 * y * y * y / 1024) * Math.sin(2 * d) + (15 * y * y / 256 + 45 * y * y * y / 1024) * Math.sin(4 * d) - 35 * y * y * y / 3072 * Math.sin(6 * d));
            var m = p * s * (r + (1 - i + a) * r * r * r / 6 + (5 - 18 * i + i * i + 72 * a - 58 * e) * r * r * r * r * r / 120) + 5e5,
                _ = p * (o + s * Math.tan(d) * (r * r / 2 + (5 - i + 9 * a + 4 * a * a) * r * r * r * r / 24 + (61 - 58 * i + i * i + 600 * a - 330 * e) * r * r * r * r * r * r / 720));
            l < 0 && (_ += 1e7);
            return {
...
function ce(t) {
    ...
    var r, o, n, h, l, u, c, y, p, d = .9996,
        g = 6378137,
        m = .00669438,
        _ = (1 - Math.sqrt(.99330562)) / (1 + Math.sqrt(.99330562)),
        f = s - 5e5,
        M = e;
    i < "N" && (M -= 1e7), c = 6 * (a - 1) - 180 + 3, r = .006739496752268451, p = (y = M / d / 6367449.145945056) + (3 * _ / 2 - 27 * _ * _ * _ / 32) * Math.sin(2 * y) + (21 * _ * _ / 16 - 55 * _ * _ * _ * _ / 32) * Math.sin(4 * y) + 151 * _ * _ * _ / 96 * Math.sin(6 * y), o = g / Math.sqrt(1 - m * Math.sin(p) * Math.sin(p)), n = Math.tan(p) * Math.tan(p), h = r * Math.cos(p) * Math.cos(p), l = .99330562 * g / Math.pow(1 - m * Math.sin(p) * Math.sin(p), 1.5), u = f / (o * d);
    var w = p - o * Math.tan(p) / l * (u * u / 2 - (5 + 3 * n + 10 * h - 4 * h * h - 9 * r) * u * u * u * u / 24 + (61 + 90 * n + 298 * h + 45 * n * n - 1.6983531815716497 - 3 * h * h) * u * u * u * u * u * u / 720);
    w = ue(w);
    var P, E = (u - (1 + 2 * n + h) * u * u * u / 6 + (5 - 2 * h + 28 * n - 3 * h * h + 8 * r + 24 * n * n) * u * u * u * u * u / 120) / Math.cos(p);
    if (E = c + ue(E), t.accuracy) {
        var v = ce({
...
function de(t) {
    ...
    for (var e, s = t.length, i = null, a = "", r = 0; !/[A-Z]/.test(e = t.charAt(r));) {
        if (r >= 2) throw "MGRSPoint bad conversion from: " + t;
        a += e, r++
    }
    var o = parseInt(a, 10);
    if (0 === r || r + 3 > s) throw "MGRSPoint bad conversion from: " + t;
    var n = t.charAt(r++);
    if (n <= "A" || "B" === n || "Y" === n || n >= "Z" || "I" === n || "O" === n) throw "MGRSPoint zone letter " + n + " not handled: " + t;
    i = t.substring(r, r += 2);
    for (var h = pe(o), l = function(t, e) {
            var s = $t.charCodeAt(e - 1),
                i = 1e5,
                a = !1;
            for (; s !== t.charCodeAt(0);) {
                if (++s === se && s++, s === ie && s++, s > re) {
            ...
            return i
        }(i.charAt(0), h), u = function(t, e) {
            if (t > "V") throw "MGRSPoint given invalid Northing " + t;
            var s = te.charCodeAt(e - 1),
                i = 0,
                a = !1;
            for (; s !== t.charCodeAt(0);) {
                if (++s === se && s++, s === ie && s++, s > ae) {
                    if (a) throw "Bad character: " + t;
                    s = ee, a = !0
                }
                i += 1e5
            ...
            return i
        }(i.charAt(1), h); u < ge(n);) u += 2e6;
    var c = s - r;
    if (c % 2 != 0) throw "MGRSPoint has to have an even number \nof digits after the zone letter and two 100km letters - front \nhalf for easting meters, second half for \nnorthing meters" + t;
    var y, p, d, g = c / 2,
        m = 0,
        _ = 0;
    return g > 0 && (y = 1e5 / Math.pow(10, g), p = t.substring(r, r + g), m = parseFloat(p) * y, d = t.substring(r + g), _ = parseFloat(d) * y), {
        easting: m + l,
        northing: _ + u,
        zoneLetter: n,
        zoneNumber: o,
...
function me(t, e, s) {
    if (!(this instanceof me)) return new me(t, e, s);
    if (Array.isArray(t)) this.x = t[0], this.y = t[1], this.z = t[2] || 0;
        ...
        var i = t.split(",");
        this.x = parseFloat(i[0]), this.y = parseFloat(i[1]), this.z = parseFloat(i[2]) || 0
    } else this.x = t, this.y = e, this.z = s || 0;
    console.warn("proj4.Point will be removed in version 3, use proj4.toPoint")
}
me.fromMGRS = function(t) {
    return new me(he(t))
}, me.prototype.toMGRS = function(t) {
    return ne([this.x, this.y], t)
};
var _e = 1,
    fe = .25,
    Me = .046875,
    ...
    Ee = .75,
    ve = .46875,
    Se = .013020833333333334,
    xe = .007120768229166667,
    Ge = .3645833333333333,
    be = .005696614583333333,
    Ae = .3076171875;

function Ne(t) {
    var e = [];
    e[0] = _e - t * (fe + t * (Me + t * (we + t * Pe))), e[1] = t * (Ee - t * (Me + t * (we + t * Pe)));
    var s = t * t;
    return e[2] = s * (ve - t * (Se + t * xe)), s *= t, e[3] = s * (Ge - t * be), e[4] = s * t * Ae, e
}

function Fe(t, e, s, i) {
    return s *= e, e *= e, i[0] * t - s * (i[1] + e * (i[2] + e * (i[3] + e * i[4])))
}
var Ie = 20;

function Ce(t, e, s) {
    for (var i = 1 / (1 - e), a = t, r = Ie; r; --r) {
        var o = Math.sin(a),
            n = 1 - e * o * o;
        if (a -= n = (Fe(a, o, Math.cos(a), s) - t) * (n * Math.sqrt(n)) * i, Math.abs(n) < G) return a
    }
    return a
}
const Re = {
    init: function() {
        this.x0 = void 0 !== this.x0 ? this.x0 : 0, this.y0 = void 0 !== this.y0 ? this.y0 : 0, this.long0 = void 0 !== this.long0 ? this.long0 : 0, this.lat0 = void 0 !== this.lat0 ? this.lat0 : 0, this.es && (this.en = Ne(this.es), this.ml0 = Fe(this.lat0, Math.sin(this.lat0), Math.cos(this.lat0), this.en))
    },
    forward: function(t) {
        var e, s, i, a = t.x,
            r = t.y,
        ...
        if (this.es) {
            var l = h * o,
                ...
                y = Math.pow(c, 2),
                p = Math.abs(h) > G ? Math.tan(r) : 0,
                d = Math.pow(p, 2),
                g = Math.pow(d, 2);
            e = 1 - this.es * Math.pow(n, 2), l /= Math.sqrt(e);
            var m = Fe(r, n, h, this.en);
            s = this.a * (this.k0 * l * (1 + u / 6 * (1 - d + c + u / 20 * (5 - 18 * d + g + 14 * c - 58 * d * c + u / 42 * (61 + 179 * g - g * d - 479 * d))))) + this.x0, i = this.a * (this.k0 * (m - this.ml0 + n * o * l / 2 * (1 + u / 12 * (5 - d + 9 * c + 4 * y + u / 30 * (61 + g - 58 * d + 270 * c - 330 * d * c + u / 56 * (1385 + 543 * g - g * d - 3111 * d)))))) + this.y0
        } else {
            var _ = h * Math.sin(o);
            if (Math.abs(Math.abs(_) - 1) < G) return 93;
            if (s = .5 * this.a * this.k0 * Math.log((1 + _) / (1 - _)) + this.x0, i = h * Math.cos(o) / Math.sqrt(1 - Math.pow(_, 2)), (_ = Math.abs(i)) >= 1) {
                if (_ - 1 > G) return 93;
                i = 0
            } else i = Math.acos(i);
            r < 0 && (i = -i), i = this.a * this.k0 * (i - this.lat0) + this.y0
        }
        return t.x = s, t.y = i, t
    },
    inverse: function(t) {
        var e, s, i, a, r = (t.x - this.x0) * (1 / this.a),
            o = (t.y - this.y0) * (1 / this.a);
        if (this.es)
            if (s = Ce(e = this.ml0 + o / this.k0, this.es, this.en), Math.abs(s) < E) {
                var n = Math.sin(s),
                    h = Math.cos(s),
                    l = Math.abs(h) > G ? Math.tan(s) : 0,
                    u = this.ep2 * Math.pow(h, 2),
                    c = Math.pow(u, 2),
                    y = Math.pow(l, 2),
                    p = Math.pow(y, 2);
                e = 1 - this.es * Math.pow(n, 2);
                var d = r * Math.sqrt(e) / this.k0,
                    g = Math.pow(d, 2);
                i = s - (e *= l) * g / (1 - this.es) * .5 * (1 - g / 12 * (5 + 3 * y - 9 * u * y + u - 4 * c - g / 30 * (61 + 90 * y - 252 * u * y + 45 * p + 46 * u - g / 56 * (1385 + 3633 * y + 4095 * p + 1574 * p * y)))), a = pt(this.long0 + d * (1 - g / 6 * (1 + 2 * y + u - g / 20 * (5 + 28 * y + 24 * p + 8 * u * y + 6 * u - g / 42 * (61 + 662 * y + 1320 * p + 720 * p * y)))) / h)
            } else i = E * yt(o), a = 0;
        else {
            var m = Math.exp(r / this.k0),
                _ = .5 * (m - 1 / m),
                f = this.lat0 + o / this.k0,
                M = Math.cos(f);
            e = Math.sqrt((1 - Math.pow(M, 2)) / (1 + Math.pow(_, 2))), i = Math.asin(e), o < 0 && (i = -i), a = 0 === _ && 0 === M ? 0 : pt(Math.atan2(_, M) + this.long0)
        }
...
function ke(t, e) {
    ...
    var s = Math.max(t, e),
        i = Math.min(t, e) / (s || 1);
    return s * Math.sqrt(1 + Math.pow(i, 2))
}
...
function Te(t) {
    ...
    return e = function(t) {
        var e = 1 + t,
            s = e - 1;
        return 0 === s ? t : t * Math.log(e) / s
    }(e * (1 + e / (ke(1, e) + 1))), t < 0 ? -e : e
}

function Le(t, e) {
    for (var s, i = 2 * Math.cos(2 * e), a = t.length - 1, r = t[a], o = 0; --a >= 0;) s = i * r - o + t[a], o = r, r = s;
    return e + s * Math.sin(2 * e)
}

function je(t, e, s) {
    for (var i, a, r = Math.sin(e), o = Math.cos(e), n = Oe(s), h = function(t) {
            var e = Math.exp(t);
            return (e + 1 / e) / 2
        }(s), l = 2 * o * h, u = -2 * r * n, c = t.length - 1, y = t[c], p = 0, d = 0, g = 0; --c >= 0;) i = d, a = p, y = l * (d = y) - i - u * (p = g) + t[c], g = u * d - a + l * p;
    return [(l = r * h) * y - (u = o * n) * g, l * g + u * y]
}
const qe = {
    init: function() {
    ...
    forward: function(t) {
        ...
        var i = Math.sin(s),
            ...
            r = Math.sin(e),
            o = Math.cos(e);
        s = Math.atan2(i, o * a), e = Math.atan2(r * a, ke(i, a * o)), e = Te(Math.tan(e));
        var n, h, l = je(this.gtu, 2 * s, 2 * e);
        return s += l[0], e += l[1], Math.abs(e) <= 2.623395162778 ? (n = this.a * (this.Qn * e) + this.x0, h = this.a * (this.Qn * s + this.Zb) + this.y0) : (n = 1 / 0, h = 1 / 0), t.x = n, t.y = h, t
    },
    inverse: function(t) {
        var e, s, i = (t.x - this.x0) * (1 / this.a),
            a = (t.y - this.y0) * (1 / this.a);
        if (a = (a - this.Zb) / this.Qn, i /= this.Qn, Math.abs(i) <= 2.623395162778) {
            var r = je(this.utg, 2 * a, 2 * i);
            a += r[0], i += r[1], i = Math.atan(Oe(i));
            var o = Math.sin(a),
                n = Math.cos(a),
                h = Math.sin(i),
                l = Math.cos(i);
            a = Math.atan2(o * l, ke(h, l * n)), e = pt((i = Math.atan2(h, l * n)) + this.long0), s = Le(this.cgb, a)
        } else e = 1 / 0, s = 1 / 0;
        return t.x = e, t.y = s, t
    },
...
const Be = {
    init: function() {
        var t = function(t, e) {
            if (void 0 === t) {
                if ((t = Math.floor(30 * (pt(e) + Math.PI) / Math.PI) + 1) < 0) return 0;
                if (t > 60) return 60
            }
            return t
        }(this.zone, this.long0);
        if (void 0 === t) throw new Error("unknown utm zone");
        this.lat0 = 0, this.long0 = (6 * Math.abs(t) - 183) * b, this.x0 = 5e5, this.y0 = this.utmSouth ? 1e7 : 0, this.k0 = .9996, qe.init.apply(this), this.forward = qe.forward, this.inverse = qe.inverse
    },
...
const De = {
    init: function() {
        ...
        e *= e, this.rc = Math.sqrt(1 - this.es) / (1 - this.es * t * t), this.C = Math.sqrt(1 + this.es * e * e / (1 - this.es)), this.phic0 = Math.asin(t / this.C), this.ratexp = .5 * this.C * this.e, this.K = Math.tan(.5 * this.phic0 + N) / (Math.pow(Math.tan(.5 * this.lat0 + N), this.C) * Ue(this.e * t, this.ratexp))
    },
    forward: function(t) {
        var e = t.x,
            s = t.y;
        return t.y = 2 * Math.atan(this.K * Math.pow(Math.tan(.5 * s + N), this.C) * Ue(this.e * Math.sin(s), this.ratexp)) - E, t.x = this.C * e, t
    },
    inverse: function(t) {
        for (var e = t.x / this.C, s = t.y, i = Math.pow(Math.tan(.5 * s + N) / this.K, 1 / this.C), a = 20; a > 0 && (s = 2 * Math.atan(i * Ue(this.e * Math.sin(t.y), -.5 * this.e)) - E, !(Math.abs(s - t.y) < 1e-14)); --a) t.y = s;
        return a ? (t.x = e, t.y = s, t) : null
    },
    names: ["gauss"]
};
const ze = {
    init: function() {
        De.init.apply(this), this.rc && (this.sinc0 = Math.sin(this.phic0), this.cosc0 = Math.cos(this.phic0), this.R2 = 2 * this.rc, this.title || (this.title = "Oblique Stereographic Alternative"))
    },
    forward: function(t) {
        var e, s, i, a;
        return t.x = pt(t.x - this.long0), De.forward.apply(this, [t]), e = Math.sin(t.y), s = Math.cos(t.y), i = Math.cos(t.x), a = this.k0 * this.R2 / (1 + this.sinc0 * e + this.cosc0 * s * i), t.x = a * s * Math.sin(t.x), t.y = a * (this.cosc0 * e - this.sinc0 * s * i), t.x = this.a * t.x + this.x0, t.y = this.a * t.y + this.y0, t
    },
    inverse: function(t) {
        var e, s, i, a, r;
        if (t.x = (t.x - this.x0) / this.a, t.y = (t.y - this.y0) / this.a, t.x /= this.k0, t.y /= this.k0, r = ke(t.x, t.y)) {
            var o = 2 * Math.atan2(r, this.R2);
            e = Math.sin(o), s = Math.cos(o), a = Math.asin(s * this.sinc0 + t.y * e * this.cosc0 / r), i = Math.atan2(t.x * e, r * this.cosc0 * s - t.y * this.sinc0 * e)
        } else a = this.phic0, i = 0;
        return t.x = i, t.y = a, De.inverse.apply(this, [t]), t.x = pt(t.x + this.long0), t
    },
    names: ["Stereographic_North_Pole", "Oblique_Stereographic", "sterea", "Oblique Stereographic Alternative", "Double_Stereographic"]
};

function He(t, e, s) {
    return e *= s, Math.tan(.5 * (E + t)) * Math.pow((1 - e) / (1 + e), .5 * s)
}
const We = {
    init: function() {
        this.x0 = this.x0 || 0, this.y0 = this.y0 || 0, this.lat0 = this.lat0 || 0, this.long0 = this.long0 || 0, this.coslat0 = Math.cos(this.lat0), this.sinlat0 = Math.sin(this.lat0), this.sphere ? 1 === this.k0 && !isNaN(this.lat_ts) && Math.abs(this.coslat0) <= G && (this.k0 = .5 * (1 + yt(this.lat0) * Math.sin(this.lat_ts))) : (Math.abs(this.coslat0) <= G && (this.lat0 > 0 ? this.con = 1 : this.con = -1), this.cons = Math.sqrt(Math.pow(1 + this.e, 1 + this.e) * Math.pow(1 - this.e, 1 - this.e)), 1 === this.k0 && !isNaN(this.lat_ts) && Math.abs(this.coslat0) <= G && Math.abs(Math.cos(this.lat_ts)) > G && (this.k0 = .5 * this.cons * ct(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)) / dt(this.e, this.con * this.lat_ts, this.con * Math.sin(this.lat_ts))), this.ms1 = ct(this.e, this.sinlat0, this.coslat0), this.X0 = 2 * Math.atan(He(this.lat0, this.sinlat0, this.e)) - E, this.cosX0 = Math.cos(this.X0), this.sinX0 = Math.sin(this.X0))
    },
    forward: function(t) {
        var e, s, i, a, r, o, n = t.x,
            h = t.y,
            l = Math.sin(h),
            u = Math.cos(h),
            c = pt(n - this.long0);
        return Math.abs(Math.abs(n - this.long0) - Math.PI) <= G && Math.abs(h + this.lat0) <= G ? (t.x = NaN, t.y = NaN, t) : this.sphere ? (e = 2 * this.k0 / (1 + this.sinlat0 * l + this.coslat0 * u * Math.cos(c)), t.x = this.a * e * u * Math.sin(c) + this.x0, t.y = this.a * e * (this.coslat0 * l - this.sinlat0 * u * Math.cos(c)) + this.y0, t) : (s = 2 * Math.atan(He(h, l, this.e)) - E, a = Math.cos(s), i = Math.sin(s), Math.abs(this.coslat0) <= G ? (r = dt(this.e, h * this.con, this.con * l), o = 2 * this.a * this.k0 * r / this.cons, t.x = this.x0 + o * Math.sin(n - this.long0), t.y = this.y0 - this.con * o * Math.cos(n - this.long0), t) : (Math.abs(this.sinlat0) < G ? (e = 2 * this.a * this.k0 / (1 + a * Math.cos(c)), t.y = e * i) : (e = 2 * this.a * this.k0 * this.ms1 / (this.cosX0 * (1 + this.sinX0 * i + this.cosX0 * a * Math.cos(c))), t.y = e * (this.cosX0 * i - this.sinX0 * a * Math.cos(c)) + this.y0), t.x = e * a * Math.sin(c) + this.x0, t))
    },
    inverse: function(t) {
        var e, s, i, a, r;
        ...
        if (this.sphere) {
            var n = 2 * Math.atan(o / (2 * this.a * this.k0));
            return e = this.long0, s = this.lat0, o <= G ? (t.x = e, t.y = s, t) : (s = Math.asin(Math.cos(n) * this.sinlat0 + t.y * Math.sin(n) * this.coslat0 / o), e = Math.abs(this.coslat0) < G ? this.lat0 > 0 ? pt(this.long0 + Math.atan2(t.x, -1 * t.y)) : pt(this.long0 + Math.atan2(t.x, t.y)) : pt(this.long0 + Math.atan2(t.x * Math.sin(n), o * this.coslat0 * Math.cos(n) - t.y * this.sinlat0 * Math.sin(n))), t.x = e, t.y = s, t)
        }
        if (Math.abs(this.coslat0) <= G) {
            if (o <= G) return s = this.lat0, e = this.long0, t.x = e, t.y = s, t;
            t.x *= this.con, t.y *= this.con, i = o * this.cons / (2 * this.a * this.k0), s = this.con * gt(this.e, i), e = this.con * pt(this.con * this.long0 + Math.atan2(t.x, -1 * t.y))
        } else a = 2 * Math.atan(o * this.cosX0 / (2 * this.a * this.k0 * this.ms1)), e = this.long0, o <= G ? r = this.X0 : (r = Math.asin(Math.cos(a) * this.sinX0 + t.y * Math.sin(a) * this.cosX0 / o), e = pt(this.long0 + Math.atan2(t.x * Math.sin(a), o * this.cosX0 * Math.cos(a) - t.y * this.sinX0 * Math.sin(a)))), s = -1 * gt(this.e, Math.tan(.5 * (E + r)));
        return t.x = e, t.y = s, t
    },
    names: ["stere", "Stereographic_South_Pole", "Polar_Stereographic_variant_A", "Polar_Stereographic_variant_B", "Polar_Stereographic"],
    ssfn_: He
};
const Ke = {
    init: function() {
        ...
        var e = Math.sin(t),
            ...
            i = 1 / this.rf,
            a = 2 * i - Math.pow(i, 2),
            r = this.e = Math.sqrt(a);
        this.R = this.k0 * s * Math.sqrt(1 - a) / (1 - a * Math.pow(e, 2)), this.alpha = Math.sqrt(1 + a / (1 - a) * Math.pow(Math.cos(t), 4)), this.b0 = Math.asin(e / this.alpha);
        var o = Math.log(Math.tan(Math.PI / 4 + this.b0 / 2)),
            n = Math.log(Math.tan(Math.PI / 4 + t / 2)),
            h = Math.log((1 + r * e) / (1 - r * e));
        this.K = o - this.alpha * n + this.alpha * r / 2 * h
    },
    forward: function(t) {
        var e = Math.log(Math.tan(Math.PI / 4 - t.y / 2)),
            s = this.e / 2 * Math.log((1 + this.e * Math.sin(t.y)) / (1 - this.e * Math.sin(t.y))),
            i = -this.alpha * (e + s) + this.K,
            a = 2 * (Math.atan(Math.exp(i)) - Math.PI / 4),
            r = this.alpha * (t.x - this.lambda0),
            o = Math.atan(Math.sin(r) / (Math.sin(this.b0) * Math.tan(a) + Math.cos(this.b0) * Math.cos(r))),
            n = Math.asin(Math.cos(this.b0) * Math.sin(a) - Math.sin(this.b0) * Math.cos(a) * Math.cos(r));
        return t.y = this.R / 2 * Math.log((1 + Math.sin(n)) / (1 - Math.sin(n))) + this.y0, t.x = this.R * o + this.x0, t
    },
    inverse: function(t) {
        for (var e = t.x - this.x0, s = t.y - this.y0, i = e / this.R, a = 2 * (Math.atan(Math.exp(s / this.R)) - Math.PI / 4), r = Math.asin(Math.cos(this.b0) * Math.sin(a) + Math.sin(this.b0) * Math.cos(a) * Math.cos(i)), o = Math.atan(Math.sin(i) / (Math.cos(this.b0) * Math.cos(i) - Math.sin(this.b0) * Math.tan(a))), n = this.lambda0 + o / this.alpha, h = 0, l = r, u = -1e3, c = 0; Math.abs(l - u) > 1e-7;) {
            if (++c > 20) return;
...
const Je = {
    init: function() {
        var t, e, s, i, a, r, o, n, h, l, u, c, y, p, d = 0,
            g = 0,
            m = 0,
            _ = 0,
            f = 0,
            M = 0,
            w = 0;
        this.no_off = (y = ["Hotine_Oblique_Mercator", "Hotine_Oblique_Mercator_variant_A", "Hotine_Oblique_Mercator_Azimuth_Natural_Origin"], p = "object" == typeof(c = this).projName ? Object.keys(c.projName)[0] : c.projName, "no_uoff" in c || "no_off" in c || -1 !== y.indexOf(p) || -1 !== y.indexOf(Pt(p))), this.no_rot = "no_rot" in this;
        var P = !1;
        "alpha" in this && (P = !0);
        var v = !1;
        if ("rectified_grid_angle" in this && (v = !0), P && (w = this.alpha), v && (d = this.rectified_grid_angle), P || v) g = this.longc;
        else if (m = this.long1, f = this.lat1, _ = this.long2, M = this.lat2, Math.abs(f - M) <= Qe || (t = Math.abs(f)) <= Qe || Math.abs(t - E) <= Qe || Math.abs(Math.abs(this.lat0) - E) <= Qe || Math.abs(Math.abs(M) - E) <= Qe) throw new Error;
        var S = 1 - this.es;
        e = Math.sqrt(S), Math.abs(this.lat0) > G ? (n = Math.sin(this.lat0), s = Math.cos(this.lat0), t = 1 - this.es * n * n, this.B = s * s, this.B = Math.sqrt(1 + this.es * this.B * this.B / S), this.A = this.B * this.k0 * e / t, (a = (i = this.B * e / (s * Math.sqrt(t))) * i - 1) <= 0 ? a = 0 : (a = Math.sqrt(a), this.lat0 < 0 && (a = -a)), this.E = a += i, this.E *= Math.pow(dt(this.e, this.lat0, n), this.B)) : (this.B = 1 / e, this.A = this.k0, this.E = i = a = 1), P || v ? (P ? (u = Math.asin(Math.sin(w) / i), v || (d = w)) : (u = d, w = Math.asin(i * Math.sin(u))), this.lam0 = g - Math.asin(.5 * (a - 1 / a) * Math.tan(u)) / this.B) : (r = Math.pow(dt(this.e, f, Math.sin(f)), this.B), o = Math.pow(dt(this.e, M, Math.sin(M)), this.B), a = this.E / r, h = (o - r) / (o + r), l = ((l = this.E * this.E) - o * r) / (l + o * r), (t = m - _) < -Math.PI ? _ -= F : t > Math.PI && (_ += F), this.lam0 = pt(.5 * (m + _) - Math.atan(l * Math.tan(.5 * this.B * (m - _)) / h) / this.B), u = Math.atan(2 * Math.sin(this.B * pt(m - this.lam0)) / (a - 1 / a)), d = w = Math.asin(i * Math.sin(u))), this.singam = Math.sin(u), this.cosgam = Math.cos(u), this.sinrot = Math.sin(d), this.cosrot = Math.cos(d), this.rB = 1 / this.B, this.ArB = this.A * this.rB, this.BrA = 1 / this.ArB, this.no_off ? this.u_0 = 0 : (this.u_0 = Math.abs(this.ArB * Math.atan(Math.sqrt(i * i - 1) / Math.cos(w))), this.lat0 < 0 && (this.u_0 = -this.u_0)), a = .5 * u, this.v_pole_n = this.ArB * Math.log(Math.tan(N - a)), this.v_pole_s = this.ArB * Math.log(Math.tan(N + a))
    },
    forward: function(t) {
        var e, s, i, a, r, o, n, h, l = {};
        if (t.x = t.x - this.lam0, Math.abs(Math.abs(t.y) - E) > G) {
            if (e = .5 * ((r = this.E / Math.pow(dt(this.e, t.y, Math.sin(t.y)), this.B)) - (o = 1 / r)), s = .5 * (r + o), a = Math.sin(this.B * t.x), i = (e * this.singam - a * this.cosgam) / s, Math.abs(Math.abs(i) - 1) < G) throw new Error;
            h = .5 * this.ArB * Math.log((1 - i) / (1 + i)), o = Math.cos(this.B * t.x), n = Math.abs(o) < Qe ? this.A * t.x : this.ArB * Math.atan2(e * this.cosgam + a * this.singam, o)
        } else h = t.y > 0 ? this.v_pole_n : this.v_pole_s, n = this.ArB * t.y;
        return this.no_rot ? (l.x = n, l.y = h) : (n -= this.u_0, l.x = h * this.cosrot + n * this.sinrot, l.y = n * this.cosrot - h * this.sinrot), l.x = this.a * l.x + this.x0, l.y = this.a * l.y + this.y0, l
    },
    inverse: function(t) {
        var e, s, i, a, r, o, n, h = {};
        if (t.x = (t.x - this.x0) * (1 / this.a), t.y = (t.y - this.y0) * (1 / this.a), this.no_rot ? (s = t.y, e = t.x) : (s = t.x * this.cosrot - t.y * this.sinrot, e = t.y * this.cosrot + t.x * this.sinrot + this.u_0), a = .5 * ((i = Math.exp(-this.BrA * s)) - 1 / i), r = .5 * (i + 1 / i), n = ((o = Math.sin(this.BrA * e)) * this.cosgam + a * this.singam) / r, Math.abs(Math.abs(n) - 1) < G) h.x = 0, h.y = n < 0 ? -E : E;
        else {
            if (h.y = this.E / Math.sqrt((1 + n) / (1 - n)), h.y = gt(this.e, Math.pow(h.y, 1 / this.B)), h.y === 1 / 0) throw new Error;
    ...
    init: function() {
        if (this.lat2 || (this.lat2 = this.lat1), this.k0 || (this.k0 = 1), this.x0 = this.x0 || 0, this.y0 = this.y0 || 0, !(Math.abs(this.lat1 + this.lat2) < G)) {
            ...
            var e = Math.sin(this.lat1),
                ...
                i = ct(this.e, e, s),
                a = dt(this.e, this.lat1, e),
                r = Math.sin(this.lat2),
                o = Math.cos(this.lat2),
                n = ct(this.e, r, o),
                h = dt(this.e, this.lat2, r),
                l = Math.abs(Math.abs(this.lat0) - E) < G ? 0 : dt(this.e, this.lat0, Math.sin(this.lat0));
            Math.abs(this.lat1 - this.lat2) > G ? this.ns = Math.log(i / n) / Math.log(a / h) : this.ns = e, isNaN(this.ns) && (this.ns = e), this.f0 = i / (this.ns * Math.pow(a, this.ns)), this.rh = this.a * this.f0 * Math.pow(l, this.ns), this.title || (this.title = "Lambert Conformal Conic")
        }
    },
    forward: function(t) {
        var e = t.x,
            s = t.y;
        Math.abs(2 * Math.abs(s) - Math.PI) <= G && (s = yt(s) * (E - 2 * G));
        var i, a, r = Math.abs(Math.abs(s) - E);
        if (r > G) i = dt(this.e, s, Math.sin(s)), a = this.a * this.f0 * Math.pow(i, this.ns);
        else {
            if ((r = s * this.ns) <= 0) return null;
            a = 0
        }
        var o = this.ns * pt(e - this.long0);
        return t.x = this.k0 * (a * Math.sin(o)) + this.x0, t.y = this.k0 * (this.rh - a * Math.cos(o)) + this.y0, t
    },
    inverse: function(t) {
        var e, s, i, a, r, o = (t.x - this.x0) / this.k0,
            n = this.rh - (t.y - this.y0) / this.k0;
        this.ns > 0 ? (e = Math.sqrt(o * o + n * n), s = 1) : (e = -Math.sqrt(o * o + n * n), s = -1);
        var h = 0;
        if (0 !== e && (h = Math.atan2(s * o, s * n)), 0 !== e || this.ns > 0) {
            if (s = 1 / this.ns, i = Math.pow(e / (this.a * this.f0), s), -9999 === (a = gt(this.e, i))) return null
        } else a = -E;
        return r = pt(h / this.ns + this.long0), t.x = r, t.y = a, t
    },
...
const Ve = {
    ...
    forward: function(t) {
        var e, s, i, a, r, o, n, h = t.x,
            l = t.y,
            u = pt(h - this.long0);
        return e = Math.pow((1 + this.e * Math.sin(l)) / (1 - this.e * Math.sin(l)), this.alfa * this.e / 2), s = 2 * (Math.atan(this.k * Math.pow(Math.tan(l / 2 + this.s45), this.alfa) / e) - this.s45), i = -u * this.alfa, a = Math.asin(Math.cos(this.ad) * Math.sin(s) + Math.sin(this.ad) * Math.cos(s) * Math.cos(i)), r = Math.asin(Math.cos(s) * Math.sin(i) / Math.cos(a)), o = this.n * r, n = this.ro0 * Math.pow(Math.tan(this.s0 / 2 + this.s45), this.n) / Math.pow(Math.tan(a / 2 + this.s45), this.n), t.y = n * Math.cos(o) / 1, t.x = n * Math.sin(o) / 1, this.czech || (t.y *= -1, t.x *= -1), t
    },
    inverse: function(t) {
        var e, s, i, a, r, o, n, h = t.x;
        t.x = t.y, t.y = h, this.czech || (t.y *= -1, t.x *= -1), r = Math.sqrt(t.x * t.x + t.y * t.y), a = Math.atan2(t.y, t.x) / Math.sin(this.s0), i = 2 * (Math.atan(Math.pow(this.ro0 / r, 1 / this.n) * Math.tan(this.s0 / 2 + this.s45)) - this.s45), e = Math.asin(Math.cos(this.ad) * Math.sin(i) - Math.sin(this.ad) * Math.cos(i) * Math.cos(a)), s = Math.asin(Math.cos(i) * Math.sin(a) / Math.cos(e)), t.x = this.long0 - s / this.alfa, o = e, n = 0;
        var l = 0;
        do {
            t.y = 2 * (Math.atan(Math.pow(this.k, -1 / this.alfa) * Math.pow(Math.tan(e / 2 + this.s45), 1 / this.alfa) * Math.pow((1 + this.e * Math.sin(o)) / (1 - this.e * Math.sin(o)), this.e / 2)) - this.s45), Math.abs(o - t.y) < 1e-10 && (n = 1), o = t.y, l += 1
        } while (0 === n && l < 15);
        return l >= 15 ? null : t
    },
    names: ["Krovak", "krovak"]
...
function Ze(t, e, s, i, a) {
    return t * a - e * Math.sin(2 * a) + s * Math.sin(4 * a) - i * Math.sin(6 * a)
}
...
function is(t) {
    return Math.abs(t) < E ? t : t - yt(t) * Math.PI
}

function as(t, e, s, i, a) {
    var r, o;
    r = t / e;
    for (var n = 0; n < 15; n++)
        if (r += o = (t - (e * r - s * Math.sin(2 * r) + i * Math.sin(4 * r) - a * Math.sin(6 * r))) / (e - 2 * s * Math.cos(2 * r) + 4 * i * Math.cos(4 * r) - 6 * a * Math.cos(6 * r)), Math.abs(o) <= 1e-10) return r;
    return NaN
}
const rs = {
    init: function() {
        this.sphere || (this.e0 = Ye(this.es), this.e1 = $e(this.es), this.e2 = ts(this.es), this.e3 = es(this.es), this.ml0 = this.a * Ze(this.e0, this.e1, this.e2, this.e3, this.lat0))
    },
    forward: function(t) {
        var e, s, i = t.x,
            a = t.y;
        if (i = pt(i - this.long0), this.sphere) e = this.a * Math.asin(Math.cos(a) * Math.sin(i)), s = this.a * (Math.atan2(Math.tan(a), Math.cos(i)) - this.lat0);
        else {
            var r = Math.sin(a),
                o = Math.cos(a),
                n = ss(this.a, this.e, r),
                h = Math.tan(a) * Math.tan(a),
                l = i * Math.cos(a),
                u = l * l,
                c = this.es * o * o / (1 - this.es);
            e = n * l * (1 - u * h * (1 / 6 - (8 - h + 8 * c) * u / 120)), s = this.a * Ze(this.e0, this.e1, this.e2, this.e3, a) - this.ml0 + n * r / o * u * (.5 + (5 - h + 6 * c) * u / 24)
        }
        return t.x = e + this.x0, t.y = s + this.y0, t
    },
    inverse: function(t) {
        t.x -= this.x0, t.y -= this.y0;
        var e, s, i = t.x / this.a,
            a = t.y / this.a;
        if (this.sphere) {
            var r = a + this.lat0;
            e = Math.asin(Math.sin(r) * Math.cos(i)), s = Math.atan2(Math.tan(i), Math.cos(r))
        } else {
            var o = as(this.ml0 / this.a + a, this.e0, this.e1, this.e2, this.e3);
            if (Math.abs(Math.abs(o) - E) <= G) return t.x = this.long0, t.y = E, a < 0 && (t.y *= -1), t;
            var n = ss(this.a, this.e, Math.sin(o)),
                h = n * n * n / this.a / this.a * (1 - this.es),
                l = Math.pow(Math.tan(o), 2),
                u = i * this.a / n,
                c = u * u;
            e = o - n * Math.tan(o) / h * u * u * (.5 - (1 + 3 * l) * u * u / 24), s = u * (1 - c * (l / 3 + (1 + 3 * l) * l * c / 15)) / Math.cos(o)
        }
        return t.x = pt(s + this.long0), t.y = is(e), t
    },
...
function os(t, e) {
    var s;
    return t > 1e-7 ? (1 - t * t) * (e / (1 - (s = t * e) * s) - .5 / t * Math.log((1 - s) / (1 + s))) : 2 * e
}
var ns = .3333333333333333,
    hs = .17222222222222222,
    ls = .10257936507936508,
    us = .06388888888888888,
    cs = .0664021164021164,
    ys = .016415012942191543;
const ps = {
    init: function() {
        var t, e = Math.abs(this.lat0);
        if (Math.abs(e - E) < G ? this.mode = this.lat0 < 0 ? 1 : 2 : Math.abs(e) < G ? this.mode = 3 : this.mode = 4, this.es > 0) switch (this.qp = os(this.e, 1), this.mmf = .5 / (1 - this.es), this.apa = function(t) {
            var e, s = [];
            return s[0] = t * ns, e = t * t, s[0] += e * hs, s[1] = e * us, e *= t, s[0] += e * ls, s[1] += e * cs, s[2] = e * ys, s
        }(this.es), this.mode) {
            case 2:
            case 1:
                this.dd = 1;
            ...
            case 3:
                ...
                break;
            case 4:
                this.rq = Math.sqrt(.5 * this.qp), t = Math.sin(this.lat0), this.sinb1 = os(this.e, t) / this.qp, this.cosb1 = Math.sqrt(1 - this.sinb1 * this.sinb1), this.dd = Math.cos(this.lat0) / (Math.sqrt(1 - this.es * t * t) * this.rq * this.cosb1), this.ymf = (this.xmf = this.rq) / this.dd, this.xmf *= this.dd
        } else 4 === this.mode && (this.sinph0 = Math.sin(this.lat0), this.cosph0 = Math.cos(this.lat0))
    },
    forward: function(t) {
        var e, s, i, a, r, o, n, h, l, u, c = t.x,
            y = t.y;
        if (c = pt(c - this.long0), this.sphere) {
            if (r = Math.sin(y), u = Math.cos(y), i = Math.cos(c), this.mode === this.OBLIQ || this.mode === this.EQUIT) {
                if ((s = this.mode === this.EQUIT ? 1 + u * i : 1 + this.sinph0 * r + this.cosph0 * u * i) <= G) return null;
                e = (s = Math.sqrt(2 / s)) * u * Math.sin(c), s *= this.mode === this.EQUIT ? r : this.cosph0 * r - this.sinph0 * u * i
            } else if (this.mode === this.N_POLE || this.mode === this.S_POLE) {
                if (this.mode === this.N_POLE && (i = -i), Math.abs(y + this.lat0) < G) return null;
                s = N - .5 * y, e = (s = 2 * (this.mode === this.S_POLE ? Math.cos(s) : Math.sin(s))) * Math.sin(c), s *= i
            }
        } else {
            switch (n = 0, h = 0, l = 0, i = Math.cos(c), a = Math.sin(c), r = Math.sin(y), o = os(this.e, r), this.mode !== this.OBLIQ && this.mode !== this.EQUIT || (n = o / this.qp, h = Math.sqrt(1 - n * n)), this.mode) {
                case this.OBLIQ:
                    l = 1 + this.sinb1 * n + this.cosb1 * h * i;
                    break;
                case this.EQUIT:
                    l = 1 + h * i;
                    break;
            ...
            if (Math.abs(l) < G) return null;
            switch (this.mode) {
                case this.OBLIQ:
                case this.EQUIT:
                    l = Math.sqrt(2 / l), s = this.mode === this.OBLIQ ? this.ymf * l * (this.cosb1 * n - this.sinb1 * h * i) : (l = Math.sqrt(2 / (1 + h * i))) * n * this.ymf, e = this.xmf * l * h * a;
                    break;
                case this.N_POLE:
                case this.S_POLE:
                    o >= 0 ? (e = (l = Math.sqrt(o)) * a, s = i * (this.mode === this.S_POLE ? l : -l)) : e = s = 0
            }
        }
        return t.x = this.a * e + this.x0, t.y = this.a * s + this.y0, t
    },
    inverse: function(t) {
        t.x -= this.x0, t.y -= this.y0;
        var e, s, i, a, r, o, n, h, l, u, c = t.x / this.a,
            y = t.y / this.a;
        if (this.sphere) {
            var p, d = 0,
                g = 0;
            if ((s = .5 * (p = Math.sqrt(c * c + y * y))) > 1) return null;
            switch (s = 2 * Math.asin(s), this.mode !== this.OBLIQ && this.mode !== this.EQUIT || (g = Math.sin(s), d = Math.cos(s)), this.mode) {
                case this.EQUIT:
                    s = Math.abs(p) <= G ? 0 : Math.asin(y * g / p), c *= g, y = d * p;
                    break;
                case this.OBLIQ:
                    s = Math.abs(p) <= G ? this.lat0 : Math.asin(d * this.sinph0 + y * g * this.cosph0 / p), c *= g * this.cosph0, y = (d - Math.sin(s) * this.sinph0) * p;
                    break;
                case this.N_POLE:
                    y = -y, s = E - s;
                    break;
            ...
            e = 0 !== y || this.mode !== this.EQUIT && this.mode !== this.OBLIQ ? Math.atan2(c, y) : 0
        } else {
            if (n = 0, this.mode === this.OBLIQ || this.mode === this.EQUIT) {
                if (c /= this.dd, y *= this.dd, (o = Math.sqrt(c * c + y * y)) < G) return t.x = this.long0, t.y = this.lat0, t;
                a = 2 * Math.asin(.5 * o / this.rq), i = Math.cos(a), c *= a = Math.sin(a), this.mode === this.OBLIQ ? (n = i * this.sinb1 + y * a * this.cosb1 / o, r = this.qp * n, y = o * this.cosb1 * i - y * this.sinb1 * a) : (n = y * a / o, r = this.qp * n, y = o * i)
            } else if (this.mode === this.N_POLE || this.mode === this.S_POLE) {
                if (this.mode === this.N_POLE && (y = -y), !(r = c * c + y * y)) return t.x = this.long0, t.y = this.lat0, t;
                n = 1 - r / this.qp, this.mode === this.S_POLE && (n = -n)
            }
            e = Math.atan2(c, y), h = Math.asin(n), l = this.apa, u = h + h, s = h + l[0] * Math.sin(u) + l[1] * Math.sin(u + u) + l[2] * Math.sin(u + u + u)
        }
        return t.x = pt(this.long0 + e), t.y = s, t
    },
...
const gs = {
    init: function() {
        Math.abs(this.lat1 + this.lat2) < G || (this.temp = this.b / this.a, this.es = 1 - Math.pow(this.temp, 2), this.e3 = Math.sqrt(this.es), this.sin_po = Math.sin(this.lat1), this.cos_po = Math.cos(this.lat1), this.t1 = this.sin_po, this.con = this.sin_po, this.ms1 = ct(this.e3, this.sin_po, this.cos_po), this.qs1 = os(this.e3, this.sin_po), this.sin_po = Math.sin(this.lat2), this.cos_po = Math.cos(this.lat2), this.t2 = this.sin_po, this.ms2 = ct(this.e3, this.sin_po, this.cos_po), this.qs2 = os(this.e3, this.sin_po), this.sin_po = Math.sin(this.lat0), this.cos_po = Math.cos(this.lat0), this.t3 = this.sin_po, this.qs0 = os(this.e3, this.sin_po), Math.abs(this.lat1 - this.lat2) > G ? this.ns0 = (this.ms1 * this.ms1 - this.ms2 * this.ms2) / (this.qs2 - this.qs1) : this.ns0 = this.con, this.c = this.ms1 * this.ms1 + this.ns0 * this.qs1, this.rh = this.a * Math.sqrt(this.c - this.ns0 * this.qs0) / this.ns0)
    },
    forward: function(t) {
        var e = t.x,
            s = t.y;
        this.sin_phi = Math.sin(s), this.cos_phi = Math.cos(s);
        var i = os(this.e3, this.sin_phi),
            a = this.a * Math.sqrt(this.c - this.ns0 * i) / this.ns0,
            r = this.ns0 * pt(e - this.long0),
            o = a * Math.sin(r) + this.x0,
            n = this.rh - a * Math.cos(r) + this.y0;
        return t.x = o, t.y = n, t
    },
    inverse: function(t) {
        var e, s, i, a, r, o;
        return t.x -= this.x0, t.y = this.rh - t.y + this.y0, this.ns0 >= 0 ? (e = Math.sqrt(t.x * t.x + t.y * t.y), i = 1) : (e = -Math.sqrt(t.x * t.x + t.y * t.y), i = -1), a = 0, 0 !== e && (a = Math.atan2(i * t.x, i * t.y)), i = e * this.ns0 / this.a, this.sphere ? o = Math.asin((this.c - i * i) / (2 * this.ns0)) : (s = (this.c - i * i) / this.ns0, o = this.phi1z(this.e3, s)), r = pt(a / this.ns0 + this.long0), t.x = r, t.y = o, t
    },
    names: ["Albers_Conic_Equal_Area", "Albers_Equal_Area", "Albers", "aea"],
    phi1z: function(t, e) {
        var s, i, a, r, o = ds(.5 * e);
        if (t < G) return o;
        for (var n = t * t, h = 1; h <= 25; h++)
            if (o += r = .5 * (a = 1 - (i = t * (s = Math.sin(o))) * i) * a / Math.cos(o) * (e / (1 - n) - s / a + .5 / t * Math.log((1 - i) / (1 + i))), Math.abs(r) <= 1e-7) return o;
        return null
    }
};
const ms = {
    ...
    forward: function(t) {
        var e, s, i, a, r, o, n, h = t.x,
            l = t.y;
        return i = pt(h - this.long0), e = Math.sin(l), s = Math.cos(l), a = Math.cos(i), (r = this.sin_p14 * e + this.cos_p14 * s * a) > 0 || Math.abs(r) <= G ? (o = this.x0 + 1 * this.a * s * Math.sin(i) / r, n = this.y0 + 1 * this.a * (this.cos_p14 * e - this.sin_p14 * s * a) / r) : (o = this.x0 + this.infinity_dist * s * Math.sin(i), n = this.y0 + this.infinity_dist * (this.cos_p14 * e - this.sin_p14 * s * a)), t.x = o, t.y = n, t
    },
    inverse: function(t) {
        var e, s, i, a, r, o;
        return t.x = (t.x - this.x0) / this.a, t.y = (t.y - this.y0) / this.a, t.x /= this.k0, t.y /= this.k0, (e = Math.sqrt(t.x * t.x + t.y * t.y)) ? (a = Math.atan2(e, this.rc), s = Math.sin(a), o = ds((i = Math.cos(a)) * this.sin_p14 + t.y * s * this.cos_p14 / e), r = Math.atan2(t.x * s, e * this.cos_p14 * i - t.y * this.sin_p14 * s), r = pt(this.long0 + r)) : (o = this.phic0, r = 0), t.x = r, t.y = o, t
    },
    names: ["gnom"]
};
const _s = {
    ...
    forward: function(t) {
        var e, s, i = t.x,
            a = t.y,
            r = pt(i - this.long0);
        if (this.sphere) e = this.x0 + this.a * r * Math.cos(this.lat_ts), s = this.y0 + this.a * Math.sin(a) / Math.cos(this.lat_ts);
        else {
            var o = os(this.e, Math.sin(a));
            e = this.x0 + this.a * this.k0 * r, s = this.y0 + this.a * o * .5 / this.k0
        }
        return t.x = e, t.y = s, t
    },
    inverse: function(t) {
        var e, s;
        return t.x -= this.x0, t.y -= this.y0, this.sphere ? (e = pt(this.long0 + t.x / this.a / Math.cos(this.lat_ts)), s = Math.asin(t.y / this.a * Math.cos(this.lat_ts))) : (s = function(t, e) {
            var s = 1 - (1 - t * t) / (2 * t) * Math.log((1 - t) / (1 + t));
            if (Math.abs(Math.abs(e) - s) < 1e-6) return e < 0 ? -1 * E : E;
            for (var i, a, r, o, n = Math.asin(.5 * e), h = 0; h < 30; h++)
                if (a = Math.sin(n), r = Math.cos(n), o = t * a, n += i = Math.pow(1 - o * o, 2) / (2 * r) * (e / (1 - t * t) - a / (1 - o * o) + .5 / t * Math.log((1 - o) / (1 + o))), Math.abs(i) <= 1e-10) return n;
            return NaN
        }(this.e, 2 * t.y * this.k0 / this.a), e = pt(this.long0 + t.x / (this.a * this.k0))), t.x = e, t.y = s, t
    },
    names: ["cea"]
};
const fs = {
    ...
    forward: function(t) {
        var e = t.x,
            ...
            i = pt(e - this.long0),
            a = is(s - this.lat0);
        return t.x = this.x0 + this.a * i * this.rc, t.y = this.y0 + this.a * a, t
    },
    inverse: function(t) {
        var e = t.x,
            s = t.y;
        return t.x = pt(this.long0 + (e - this.x0) / (this.a * this.rc)), t.y = is(this.lat0 + (s - this.y0) / this.a), t
    },
    names: ["Equirectangular", "Equidistant_Cylindrical", "Equidistant_Cylindrical_Spherical", "eqc"]
};
const Ms = {
    init: function() {
        this.temp = this.b / this.a, this.es = 1 - Math.pow(this.temp, 2), this.e = Math.sqrt(this.es), this.e0 = Ye(this.es), this.e1 = $e(this.es), this.e2 = ts(this.es), this.e3 = es(this.es), this.ml0 = this.a * Ze(this.e0, this.e1, this.e2, this.e3, this.lat0)
    },
    forward: function(t) {
        var e, s, i, a = t.x,
            r = t.y,
            o = pt(a - this.long0);
        if (i = o * Math.sin(r), this.sphere) Math.abs(r) <= G ? (e = this.a * o, s = -1 * this.a * this.lat0) : (e = this.a * Math.sin(i) / Math.tan(r), s = this.a * (is(r - this.lat0) + (1 - Math.cos(i)) / Math.tan(r)));
        else if (Math.abs(r) <= G) e = this.a * o, s = -1 * this.ml0;
        else {
            var n = ss(this.a, this.e, Math.sin(r)) / Math.tan(r);
            e = n * Math.sin(i), s = this.a * Ze(this.e0, this.e1, this.e2, this.e3, r) - this.ml0 + n * (1 - Math.cos(i))
        }
        return t.x = e + this.x0, t.y = s + this.y0, t
    },
    inverse: function(t) {
        var e, s, i, a, r, o, n, h, l;
        if (i = t.x - this.x0, a = t.y - this.y0, this.sphere)
            if (Math.abs(a + this.a * this.lat0) <= G) e = pt(i / this.a + this.long0), s = 0;
            else {
                var u;
                for (o = this.lat0 + a / this.a, n = i * i / this.a / this.a + o * o, h = o, r = 20; r; --r)
                    if (h += l = -1 * (o * (h * (u = Math.tan(h)) + 1) - h - .5 * (h * h + n) * u) / ((h - o) / u - 1), Math.abs(l) <= G) {
                        s = h;
                        break
                    }
                e = pt(this.long0 + Math.asin(i * Math.tan(h) / this.a) / Math.sin(s))
            }
        else if (Math.abs(a + this.ml0) <= G) s = 0, e = pt(this.long0 + i / this.a);
        else {
            var c, y, p, d, g;
            for (o = (this.ml0 + a) / this.a, n = i * i / this.a / this.a + o * o, h = o, r = 20; r; --r)
                if (g = this.e * Math.sin(h), c = Math.sqrt(1 - g * g) * Math.tan(h), y = this.a * Ze(this.e0, this.e1, this.e2, this.e3, h), p = this.e0 - 2 * this.e1 * Math.cos(2 * h) + 4 * this.e2 * Math.cos(4 * h) - 6 * this.e3 * Math.cos(6 * h), h -= l = (o * (c * (d = y / this.a) + 1) - d - .5 * c * (d * d + n)) / (this.es * Math.sin(2 * h) * (d * d + n - 2 * o * d) / (4 * c) + (o - d) * (c * p - 2 / Math.sin(2 * h)) - p), Math.abs(l) <= G) {
                    s = h;
                    break
                }
            c = Math.sqrt(1 - this.es * Math.pow(Math.sin(s), 2)) * Math.tan(s), e = pt(this.long0 + Math.asin(i * c / this.a) / Math.sin(s))
        }
        return t.x = e, t.y = s, t
    },
...
const ws = {
    ...
    forward: function(t) {
        var e, s = t.x,
            ...
            n = 1,
            h = 0;
        for (e = 1; e <= 10; e++) n *= r, h += this.A[e] * n;
        var l, u = h,
            c = o,
            y = 1,
            p = 0,
            d = 0,
            g = 0;
        for (e = 1; e <= 6; e++) l = p * u + y * c, y = y * u - p * c, p = l, d = d + this.B_re[e] * y - this.B_im[e] * p, g = g + this.B_im[e] * y + this.B_re[e] * p;
        return t.x = g * this.a + this.x0, t.y = d * this.a + this.y0, t
    },
    inverse: function(t) {
        var e, s, i = t.x,
            a = t.y,
            ...
            u = 0,
            c = 0;
        for (e = 1; e <= 6; e++) s = l * o + h * n, h = h * o - l * n, l = s, u = u + this.C_re[e] * h - this.C_im[e] * l, c = c + this.C_im[e] * h + this.C_re[e] * l;
        for (var y = 0; y < this.iterations; y++) {
            var p, d = u,
                g = c,
                m = o,
                _ = n;
            for (e = 2; e <= 6; e++) p = g * u + d * c, d = d * u - g * c, g = p, m += (e - 1) * (this.B_re[e] * d - this.B_im[e] * g), _ += (e - 1) * (this.B_im[e] * d + this.B_re[e] * g);
            d = 1, g = 0;
            var f = this.B_re[1],
                M = this.B_im[1];
            for (e = 2; e <= 6; e++) p = g * u + d * c, d = d * u - g * c, g = p, f += e * (this.B_re[e] * d - this.B_im[e] * g), M += e * (this.B_im[e] * d + this.B_re[e] * g);
            var w = f * f + M * M;
            u = (m * f + _ * M) / w, c = (_ * f - m * M) / w
        }
        var E = u,
            v = c,
            S = 1,
            x = 0;
        for (e = 1; e <= 9; e++) S *= E, x += this.D[e] * S;
        var G = this.lat0 + x * P * 1e5,
            b = this.long0 + v;
        return t.x = b, t.y = G, t
    },
...
const Ps = {
    ...
    forward: function(t) {
        var e = t.x,
            ...
            i = pt(e - this.long0),
            a = this.x0 + this.a * i,
            r = this.y0 + this.a * Math.log(Math.tan(Math.PI / 4 + s / 2.5)) * 1.25;
        return t.x = a, t.y = r, t
    },
    inverse: function(t) {
        t.x -= this.x0, t.y -= this.y0;
        var e = pt(this.long0 + t.x / this.a),
            s = 2.5 * (Math.atan(Math.exp(.8 * t.y / this.a)) - Math.PI / 4);
        return t.x = e, t.y = s, t
    },
...
const Es = {
    init: function() {
        this.sphere ? (this.n = 1, this.m = 0, this.es = 0, this.C_y = Math.sqrt((this.m + 1) / this.n), this.C_x = this.C_y / (this.m + 1)) : this.en = Ne(this.es)
    },
    forward: function(t) {
        var e, s, i = t.x,
            a = t.y;
        if (i = pt(i - this.long0), this.sphere) {
            if (this.m)
                for (var r = this.n * Math.sin(a), o = 20; o; --o) {
                    var n = (this.m * a + Math.sin(a) - r) / (this.m + Math.cos(a));
                    if (a -= n, Math.abs(n) < G) break
                } else a = 1 !== this.n ? Math.asin(this.n * Math.sin(a)) : a;
            e = this.a * this.C_x * i * (this.m + Math.cos(a)), s = this.a * this.C_y * a
        } else {
            var h = Math.sin(a),
                l = Math.cos(a);
            s = this.a * Fe(a, h, l, this.en), e = this.a * i * l / Math.sqrt(1 - this.es * h * h)
        }
        return t.x = e, t.y = s, t
    },
    inverse: function(t) {
        var e, s, i;
        return t.x -= this.x0, s = t.x / this.a, t.y -= this.y0, e = t.y / this.a, this.sphere ? (e /= this.C_y, s /= this.C_x * (this.m + Math.cos(e)), this.m ? e = ds((this.m * e + Math.sin(e)) / this.n) : 1 !== this.n && (e = ds(Math.sin(e) / this.n)), s = pt(s + this.long0), e = is(e)) : (e = Ce(t.y / this.a, this.es, this.en), (i = Math.abs(e)) < E ? (i = Math.sin(e), s = pt(this.long0 + t.x * Math.sqrt(1 - this.es * i * i) / (this.a * Math.cos(e)))) : i - G < E && (s = this.long0)), t.x = s, t.y = e, t
    },
...
const vs = {
    init: function() {},
    forward: function(t) {
        for (var e = t.x, s = t.y, i = pt(e - this.long0), a = s, r = Math.PI * Math.sin(s);;) {
            var o = -(a + Math.sin(a) - r) / (1 + Math.cos(a));
            if (a += o, Math.abs(o) < G) break
        }
        a /= 2, Math.PI / 2 - Math.abs(s) < G && (i = 0);
        var n = .900316316158 * this.a * i * Math.cos(a) + this.x0,
            h = 1.4142135623731 * this.a * Math.sin(a) + this.y0;
        return t.x = n, t.y = h, t
    },
    inverse: function(t) {
        var e, s;
        t.x -= this.x0, t.y -= this.y0, s = t.y / (1.4142135623731 * this.a), Math.abs(s) > .999999999999 && (s = .999999999999), e = Math.asin(s);
        var i = pt(this.long0 + t.x / (.900316316158 * this.a * Math.cos(e)));
        i < -Math.PI && (i = -Math.PI), i > Math.PI && (i = Math.PI), s = (2 * e + Math.sin(2 * e)) / Math.PI, Math.abs(s) > 1 && (s = 1);
        var a = Math.asin(s);
...
const Ss = {
    init: function() {
        Math.abs(this.lat1 + this.lat2) < G || (this.lat2 = this.lat2 || this.lat1, this.temp = this.b / this.a, this.es = 1 - Math.pow(this.temp, 2), this.e = Math.sqrt(this.es), this.e0 = Ye(this.es), this.e1 = $e(this.es), this.e2 = ts(this.es), this.e3 = es(this.es), this.sin_phi = Math.sin(this.lat1), this.cos_phi = Math.cos(this.lat1), this.ms1 = ct(this.e, this.sin_phi, this.cos_phi), this.ml1 = Ze(this.e0, this.e1, this.e2, this.e3, this.lat1), Math.abs(this.lat1 - this.lat2) < G ? this.ns = this.sin_phi : (this.sin_phi = Math.sin(this.lat2), this.cos_phi = Math.cos(this.lat2), this.ms2 = ct(this.e, this.sin_phi, this.cos_phi), this.ml2 = Ze(this.e0, this.e1, this.e2, this.e3, this.lat2), this.ns = (this.ms1 - this.ms2) / (this.ml2 - this.ml1)), this.g = this.ml1 + this.ms1 / this.ns, this.ml0 = Ze(this.e0, this.e1, this.e2, this.e3, this.lat0), this.rh = this.a * (this.g - this.ml0))
    },
    forward: function(t) {
        var e, s = t.x,
            i = t.y;
        if (this.sphere) e = this.a * (this.g - i);
            ...
            var a = Ze(this.e0, this.e1, this.e2, this.e3, i);
            e = this.a * (this.g - a)
        }
        var r = this.ns * pt(s - this.long0),
            o = this.x0 + e * Math.sin(r),
            n = this.y0 + this.rh - e * Math.cos(r);
        return t.x = o, t.y = n, t
    },
    inverse: function(t) {
        var e, s, i, a;
        t.x -= this.x0, t.y = this.rh - t.y + this.y0, this.ns >= 0 ? (s = Math.sqrt(t.x * t.x + t.y * t.y), e = 1) : (s = -Math.sqrt(t.x * t.x + t.y * t.y), e = -1);
        var r = 0;
        return 0 !== s && (r = Math.atan2(e * t.x, e * t.y)), this.sphere ? (a = pt(this.long0 + r / this.ns), i = is(this.g - s / this.a), t.x = a, t.y = i, t) : (i = as(this.g - s / this.a, this.e0, this.e1, this.e2, this.e3), a = pt(this.long0 + r / this.ns), t.x = a, t.y = i, t)
    },
...
const xs = {
    ...
    forward: function(t) {
        var e, s, i = t.x,
            a = t.y,
            r = pt(i - this.long0);
        Math.abs(a) <= G && (e = this.x0 + this.R * r, s = this.y0);
        var o = ds(2 * Math.abs(a / Math.PI));
        (Math.abs(r) <= G || Math.abs(Math.abs(a) - E) <= G) && (e = this.x0, s = a >= 0 ? this.y0 + Math.PI * this.R * Math.tan(.5 * o) : this.y0 + Math.PI * this.R * -Math.tan(.5 * o));
        var n = .5 * Math.abs(Math.PI / r - r / Math.PI),
            h = n * n,
            l = Math.sin(o),
            u = Math.cos(o),
            c = u / (l + u - 1),
            ...
            p = c * (2 / l - 1),
            d = p * p,
            g = Math.PI * this.R * (n * (c - d) + Math.sqrt(h * (c - d) * (c - d) - (d + h) * (y - d))) / (d + h);
        r < 0 && (g = -g), e = this.x0 + g;
        var m = h + c;
        return g = Math.PI * this.R * (p * m - n * Math.sqrt((d + h) * (h + 1) - m * m)) / (d + h), s = a >= 0 ? this.y0 + g : this.y0 - g, t.x = e, t.y = s, t
    },
    inverse: function(t) {
        var e, s, i, a, r, o, n, h, l, u, c, y;
        return t.x -= this.x0, t.y -= this.y0, c = Math.PI * this.R, r = (i = t.x / c) * i + (a = t.y / c) * a, c = 3 * (a * a / (h = -2 * (o = -Math.abs(a) * (1 + r)) + 1 + 2 * a * a + r * r) + (2 * (n = o - 2 * a * a + i * i) * n * n / h / h / h - 9 * o * n / h / h) / 27) / (l = (o - n * n / 3 / h) / h) / (u = 2 * Math.sqrt(-l / 3)), Math.abs(c) > 1 && (c = c >= 0 ? 1 : -1), y = Math.acos(c) / 3, s = t.y >= 0 ? (-u * Math.cos(y + Math.PI / 3) - n / 3 / h) * Math.PI : -(-u * Math.cos(y + Math.PI / 3) - n / 3 / h) * Math.PI, e = Math.abs(i) < G ? this.long0 : pt(this.long0 + Math.PI * (r - 1 + Math.sqrt(1 + 2 * (i * i - a * a) + r * r)) / 2 / i), t.x = e, t.y = s, t
    },
...
const Gs = {
    ...
    forward: function(t) {
        var e, s, i, a, r, o, n, h, l, u, c, y = t.x,
            p = t.y,
            d = Math.sin(t.y),
            g = Math.cos(t.y),
            m = pt(y - this.long0);
        return this.sphere ? Math.abs(this.sin_p12 - 1) <= G ? (t.x = this.x0 + this.a * (E - p) * Math.sin(m), t.y = this.y0 - this.a * (E - p) * Math.cos(m), t) : Math.abs(this.sin_p12 + 1) <= G ? (t.x = this.x0 + this.a * (E + p) * Math.sin(m), t.y = this.y0 + this.a * (E + p) * Math.cos(m), t) : (l = this.sin_p12 * d + this.cos_p12 * g * Math.cos(m), h = (n = Math.acos(l)) ? n / Math.sin(n) : 1, t.x = this.x0 + this.a * h * g * Math.sin(m), t.y = this.y0 + this.a * h * (this.cos_p12 * d - this.sin_p12 * g * Math.cos(m)), t) : (e = Ye(this.es), s = $e(this.es), i = ts(this.es), a = es(this.es), Math.abs(this.sin_p12 - 1) <= G ? (r = this.a * Ze(e, s, i, a, E), o = this.a * Ze(e, s, i, a, p), t.x = this.x0 + (r - o) * Math.sin(m), t.y = this.y0 - (r - o) * Math.cos(m), t) : Math.abs(this.sin_p12 + 1) <= G ? (r = this.a * Ze(e, s, i, a, E), o = this.a * Ze(e, s, i, a, p), t.x = this.x0 + (r + o) * Math.sin(m), t.y = this.y0 + (r + o) * Math.cos(m), t) : Math.abs(y) < G && Math.abs(p - this.lat0) < G ? (t.x = t.y = 0, t) : (c = (u = function(t, e, s, i, a, r) {
            const o = i - e,
                n = Math.atan((1 - r) * Math.tan(t)),
                h = Math.atan((1 - r) * Math.tan(s)),
                l = Math.sin(n),
                u = Math.cos(n),
                c = Math.sin(h),
                y = Math.cos(h);
            let p, d, g, m, _, f, M, w, P, E, v, S, x, G, b, A = o,
                N = 100;
            do {
                if (d = Math.sin(A), g = Math.cos(A), m = Math.sqrt(y * d * (y * d) + (u * c - l * y * g) * (u * c - l * y * g)), 0 === m) return {
                    azi1: 0,
                    s12: 0
                };
                _ = l * c + u * y * g, f = Math.atan2(m, _), M = u * y * d / m, w = 1 - M * M, P = 0 !== w ? _ - 2 * l * c / w : 0, E = r / 16 * w * (4 + r * (4 - 3 * w)), p = A, A = o + (1 - E) * r * M * (f + E * m * (P + E * _ * (2 * P * P - 1)))
            } while (Math.abs(A - p) > 1e-12 && --N > 0);
            return 0 === N ? {
                azi1: NaN,
                s12: NaN
            } : (v = w * (a * a - a * (1 - r) * (a * (1 - r))) / (a * (1 - r) * (a * (1 - r))), S = 1 + v / 16384 * (4096 + v * (v * (320 - 175 * v) - 768)), x = v / 1024 * (256 + v * (v * (74 - 47 * v) - 128)), G = x * m * (P + x / 4 * (_ * (2 * P * P - 1) - x / 6 * P * (4 * m * m - 3) * (4 * P * P - 3))), b = a * (1 - r) * S * (f - G), {
                azi1: Math.atan2(y * d, u * c - l * y * g),
                s12: b
            })
        }(this.lat0, this.long0, p, y, this.a, this.f)).azi1, t.x = u.s12 * Math.sin(c), t.y = u.s12 * Math.cos(c), t))
    },
    inverse: function(t) {
        var e, s, i, a, r, o, n, h, l, u, c, y, p, d, g;
        if (t.x -= this.x0, t.y -= this.y0, this.sphere) {
            if ((e = Math.sqrt(t.x * t.x + t.y * t.y)) > 2 * E * this.a) return;
            return s = e / this.a, i = Math.sin(s), a = Math.cos(s), r = this.long0, Math.abs(e) <= G ? o = this.lat0 : (o = ds(a * this.sin_p12 + t.y * i * this.cos_p12 / e), n = Math.abs(this.lat0) - E, r = Math.abs(n) <= G ? this.lat0 >= 0 ? pt(this.long0 + Math.atan2(t.x, -t.y)) : pt(this.long0 - Math.atan2(-t.x, t.y)) : pt(this.long0 + Math.atan2(t.x * i, e * this.cos_p12 * a - t.y * this.sin_p12 * i))), t.x = r, t.y = o, t
        }
        return h = Ye(this.es), l = $e(this.es), u = ts(this.es), c = es(this.es), Math.abs(this.sin_p12 - 1) <= G ? (o = as(((y = this.a * Ze(h, l, u, c, E)) - (e = Math.sqrt(t.x * t.x + t.y * t.y))) / this.a, h, l, u, c), r = pt(this.long0 + Math.atan2(t.x, -1 * t.y)), t.x = r, t.y = o, t) : Math.abs(this.sin_p12 + 1) <= G ? (y = this.a * Ze(h, l, u, c, E), o = as(((e = Math.sqrt(t.x * t.x + t.y * t.y)) - y) / this.a, h, l, u, c), r = pt(this.long0 + Math.atan2(t.x, t.y)), t.x = r, t.y = o, t) : (p = Math.atan2(t.x, t.y), d = Math.sqrt(t.x * t.x + t.y * t.y), g = function(t, e, s, i, a, r) {
            const o = Math.atan((1 - r) * Math.tan(t)),
                n = Math.sin(o),
                h = Math.cos(o),
                l = Math.sin(s),
                u = Math.cos(s),
                ...
                y = h * l,
                p = 1 - y * y,
                d = p * (a * a - a * (1 - r) * (a * (1 - r))) / (a * (1 - r) * (a * (1 - r))),
                g = 1 + d / 16384 * (4096 + d * (d * (320 - 175 * d) - 768)),
                m = d / 1024 * (256 + d * (d * (74 - 47 * d) - 128));
            let _, f, M, w, P, E = i / (a * (1 - r) * g),
                v = 100;
            do {
                f = Math.cos(2 * c + E), M = Math.sin(E), w = Math.cos(E), P = m * M * (f + m / 4 * (w * (2 * f * f - 1) - m / 6 * f * (4 * M * M - 3) * (4 * f * f - 3))), _ = E, E = i / (a * (1 - r) * g) + P
            } while (Math.abs(E - _) > 1e-12 && --v > 0);
            if (0 === v) return {
                lat2: NaN,
                lon2: NaN
            };
            const S = n * M - h * w * u,
                x = r / 16 * p * (4 + r * (4 - 3 * p));
            return {
                lat2: Math.atan2(n * w + h * M * u, (1 - r) * Math.sqrt(y * y + S * S)),
                lon2: e + (Math.atan2(M * l, h * w - n * M * u) - (1 - x) * r * y * (E + x * M * (f + x * w * (2 * f * f - 1))))
            }
        }(this.lat0, this.long0, p, d, this.a, this.f), t.x = g.lon2, t.y = g.lat2, t)
    },
...
const bs = {
    ...
    forward: function(t) {
        var e, s, i, a, r, o, n, h = t.x,
            l = t.y;
        return i = pt(h - this.long0), e = Math.sin(l), s = Math.cos(l), a = Math.cos(i), ((r = this.sin_p14 * e + this.cos_p14 * s * a) > 0 || Math.abs(r) <= G) && (o = 1 * this.a * s * Math.sin(i), n = this.y0 + 1 * this.a * (this.cos_p14 * e - this.sin_p14 * s * a)), t.x = o, t.y = n, t
    },
    inverse: function(t) {
        var e, s, i, a, r, o, n;
        return t.x -= this.x0, t.y -= this.y0, s = ds((e = Math.sqrt(t.x * t.x + t.y * t.y)) / this.a), i = Math.sin(s), a = Math.cos(s), o = this.long0, Math.abs(e) <= G ? (n = this.lat0, t.x = o, t.y = n, t) : (n = ds(a * this.sin_p14 + t.y * i * this.cos_p14 / e), r = Math.abs(this.lat0) - E, Math.abs(r) <= G ? (o = this.lat0 >= 0 ? pt(this.long0 + Math.atan2(t.x, -t.y)) : pt(this.long0 - Math.atan2(-t.x, t.y)), t.x = o, t.y = n, t) : (o = pt(this.long0 + Math.atan2(t.x * i, e * this.cos_p14 * a - t.y * this.sin_p14 * i)), t.x = o, t.y = n, t))
    },
    names: ["ortho"]
};
var As = 1,
...
function ks(t, e, s, i) {
    var a;
    return t < G ? (i.value = Os.AREA_0, a = 0) : (a = Math.atan2(e, s), Math.abs(a) <= N ? i.value = Os.AREA_0 : a > N && a <= E + N ? (i.value = Os.AREA_1, a -= E) : a > E + N || a <= -(E + N) ? (i.value = Os.AREA_2, a = a >= 0 ? a - I : a + I) : (i.value = Os.AREA_3, a += E)), a
}

function Ts(t, e) {
    var s = t + e;
    return s < -I ? s += F : s > +I && (s -= F), s
}
const Ls = {
    init: function() {
        this.x0 = this.x0 || 0, this.y0 = this.y0 || 0, this.lat0 = this.lat0 || 0, this.long0 = this.long0 || 0, this.lat_ts = this.lat_ts || 0, this.title = this.title || "Quadrilateralized Spherical Cube", this.lat0 >= E - N / 2 ? this.face = Cs : this.lat0 <= -(E - N / 2) ? this.face = Rs : Math.abs(this.long0) <= N ? this.face = As : Math.abs(this.long0) <= E + N ? this.face = this.long0 > 0 ? Ns : Is : this.face = Fs, 0 !== this.es && (this.one_minus_f = 1 - (this.a - this.b) / this.a, this.one_minus_f_squared = this.one_minus_f * this.one_minus_f)
    },
    forward: function(t) {
        var e, s, i, a, r, o, n = {
                x: 0,
        ...
        if (t.x -= this.long0, e = 0 !== this.es ? Math.atan(this.one_minus_f_squared * Math.tan(t.y)) : t.y, s = t.x, this.face === Cs) a = E - e, s >= N && s <= E + N ? (h.value = Os.AREA_0, i = s - E) : s > E + N || s <= -(E + N) ? (h.value = Os.AREA_1, i = s > 0 ? s - I : s + I) : s > -(E + N) && s <= -N ? (h.value = Os.AREA_2, i = s + E) : (h.value = Os.AREA_3, i = s);
        else if (this.face === Rs) a = E + e, s >= N && s <= E + N ? (h.value = Os.AREA_0, i = -s + E) : s < N && s >= -N ? (h.value = Os.AREA_1, i = -s) : s < -N && s >= -(E + N) ? (h.value = Os.AREA_2, i = -s - E) : (h.value = Os.AREA_3, i = s > 0 ? -s + I : -s - I);
        else {
            var l, u, c, y, p, d;
            this.face === Ns ? s = Ts(s, +E) : this.face === Fs ? s = Ts(s, +I) : this.face === Is && (s = Ts(s, -E)), y = Math.sin(e), p = Math.cos(e), d = Math.sin(s), l = p * Math.cos(s), u = p * d, c = y, this.face === As ? i = ks(a = Math.acos(l), c, u, h) : this.face === Ns ? i = ks(a = Math.acos(u), c, -l, h) : this.face === Fs ? i = ks(a = Math.acos(-l), c, -u, h) : this.face === Is ? i = ks(a = Math.acos(-u), c, l, h) : (a = i = 0, h.value = Os.AREA_0)
        }
        return o = Math.atan(12 / I * (i + Math.acos(Math.sin(i) * Math.cos(N)) - E)), r = Math.sqrt((1 - Math.cos(a)) / (Math.cos(o) * Math.cos(o)) / (1 - Math.cos(Math.atan(1 / Math.cos(i))))), h.value === Os.AREA_1 ? o += E : h.value === Os.AREA_2 ? o += I : h.value === Os.AREA_3 && (o += 1.5 * I), n.x = r * Math.cos(o), n.y = r * Math.sin(o), n.x = n.x * this.a + this.x0, n.y = n.y * this.a + this.y0, t.x = n.x, t.y = n.y, t
    },
    inverse: function(t) {
        var e, s, i, a, r, o, n, h, l, u, c, y, p = {
                lam: 0,
                phi: 0
            },
            d = {
        ...
        if (t.x = (t.x - this.x0) / this.a, t.y = (t.y - this.y0) / this.a, s = Math.atan(Math.sqrt(t.x * t.x + t.y * t.y)), e = Math.atan2(t.y, t.x), t.x >= 0 && t.x >= Math.abs(t.y) ? d.value = Os.AREA_0 : t.y >= 0 && t.y >= Math.abs(t.x) ? (d.value = Os.AREA_1, e -= E) : t.x < 0 && -t.x >= Math.abs(t.y) ? (d.value = Os.AREA_2, e = e < 0 ? e + I : e - I) : (d.value = Os.AREA_3, e += E), l = I / 12 * Math.tan(e), r = Math.sin(l) / (Math.cos(l) - 1 / Math.sqrt(2)), o = Math.atan(r), (n = 1 - (i = Math.cos(e)) * i * (a = Math.tan(s)) * a * (1 - Math.cos(Math.atan(1 / Math.cos(o))))) < -1 ? n = -1 : n > 1 && (n = 1), this.face === Cs) h = Math.acos(n), p.phi = E - h, d.value === Os.AREA_0 ? p.lam = o + E : d.value === Os.AREA_1 ? p.lam = o < 0 ? o + I : o - I : d.value === Os.AREA_2 ? p.lam = o - E : p.lam = o;
        else if (this.face === Rs) h = Math.acos(n), p.phi = h - E, d.value === Os.AREA_0 ? p.lam = -o + E : d.value === Os.AREA_1 ? p.lam = -o : d.value === Os.AREA_2 ? p.lam = -o - E : p.lam = o < 0 ? -o - I : -o + I;
        else {
            var g, m, _;
            l = (g = n) * g, m = (l += (_ = l >= 1 ? 0 : Math.sqrt(1 - l) * Math.sin(o)) * _) >= 1 ? 0 : Math.sqrt(1 - l), d.value === Os.AREA_1 ? (l = m, m = -_, _ = l) : d.value === Os.AREA_2 ? (m = -m, _ = -_) : d.value === Os.AREA_3 && (l = m, m = _, _ = -l), this.face === Ns ? (l = g, g = -m, m = l) : this.face === Fs ? (g = -g, m = -m) : this.face === Is && (l = g, g = m, m = -l), p.phi = Math.acos(-_) - E, p.lam = Math.atan2(m, g), this.face === Ns ? p.lam = Ts(p.lam, -E) : this.face === Fs ? p.lam = Ts(p.lam, -I) : this.face === Is && (p.lam = Ts(p.lam, +E))
        }
        return 0 !== this.es && (u = p.phi < 0 ? 1 : 0, c = Math.tan(p.phi), y = this.b / Math.sqrt(c * c + this.one_minus_f_squared), p.phi = Math.atan(Math.sqrt(this.a * this.a - y * y) / (this.one_minus_f * y)), u && (p.phi = -p.phi)), p.lam += this.long0, t.x = p.lam, t.y = p.phi, t
    },
...
const Ks = {
    ...
    forward: function(t) {
        ...
        i < 0 ? i = 0 : i >= Hs && (i = 17);
        var a = {
            x: Ws(js[i], s = A * (s - zs * i)) * e,
            y: Ws(qs[i], s)
        };
        return t.y < 0 && (a.y = -a.y), a.x = a.x * this.a * Bs + this.x0, a.y = a.y * this.a * Us + this.y0, a
    },
    inverse: function(t) {
        var e = {
            x: (t.x - this.x0) / (this.a * Bs),
            y: Math.abs(t.y - this.y0) / (this.a * Us)
        };
        if (e.y >= 1) e.x /= js[18][0], e.y = t.y < 0 ? -E : E;
        else {
            var s = Math.floor(e.y * Hs);
            for (s < 0 ? s = 0 : s >= Hs && (s = 17);;)
                if (qs[s][0] > e.y) --s;
                else {
                    if (!(qs[s + 1][0] <= e.y)) break;
                    ++s
                }
            var i = qs[s],
                a = 5 * (e.y - i[0]) / (qs[s + 1][0] - i[0]);
            a = function(t, e, s, i) {
                for (var a = e; i; --i) {
                    var r = t(a);
                    if (a -= r, Math.abs(r) < s) break
                }
                return a
            }((function(t) {
                return (Ws(i, t) - e.y) / function(t, e) {
                    return t[1] + e * (2 * t[2] + 3 * e * t[3])
                }(i, t)
            }), a, G, 100), e.x /= Ws(js[s], a), e.y = (5 * s + a) * b, t.y < 0 && (e.y = -e.y)
        }
        return e.x = pt(e.x + this.long0), e
    },
...
const Qs = {
    ...
    forward: function(t) {
        return jt(t, this.es, this.a)
    },
    inverse: function(t) {
        return qt(t, this.es, this.a, this.b)
    },
...
const $s = {
    init: function() {
        if (Object.keys(Ys).forEach(function(t) {
                if (void 0 === this[t]) this[t] = Ys[t].def;
                else {
                    if (Ys[t].num && isNaN(this[t])) throw new Error("Invalid parameter value, must be numeric " + t + " = " + this[t]);
                    Ys[t].num && (this[t] = parseFloat(this[t]))
                }
                Ys[t].degrees && (this[t] = this[t] * b)
            }.bind(this)), Math.abs(Math.abs(this.lat0) - E) < G ? this.mode = this.lat0 < 0 ? Xs : Js : Math.abs(this.lat0) < G ? this.mode = Vs : (this.mode = Zs, this.sinph0 = Math.sin(this.lat0), this.cosph0 = Math.cos(this.lat0)), this.pn1 = this.h / this.a, this.pn1 <= 0 || this.pn1 > 1e10) throw new Error("Invalid height");
    ...
    forward: function(t) {
        t.x -= this.long0;
        var e, s, i, a, r = Math.sin(t.y),
            o = Math.cos(t.y),
            n = Math.cos(t.x);
        switch (this.mode) {
            case Zs:
                s = this.sinph0 * r + this.cosph0 * o * n;
                break;
            case Vs:
                s = o * n;
                break;
        ...
        switch (e = (s = this.pn1 / (this.p - s)) * o * Math.sin(t.x), this.mode) {
            case Zs:
                s *= this.cosph0 * r - this.sinph0 * o * n;
                break;
            case Vs:
                s *= r;
                break;
        ...
        return a = 1 / ((i = s * this.cg + e * this.sg) * this.sw * this.h1 + this.cw), e = (e * this.cg - s * this.sg) * this.cw * a, s = i * a, t.x = e * this.a, t.y = s * this.a, t
    },
    inverse: function(t) {
        ...
        i = 1 / (this.pn1 - t.y * this.sw), e = this.pn1 * t.x * i, s = this.pn1 * t.y * this.cw * i, t.x = e * this.cg + s * this.sg, t.y = s * this.cg - e * this.sg;
        var r = ke(t.x, t.y);
        if (Math.abs(r) < G) a.x = 0, a.y = t.y;
        else {
            var o, n;
            switch (n = 1 - r * r * this.pfact, n = (this.p - Math.sqrt(n)) / (this.pn1 / r + r / this.pn1), o = Math.sqrt(1 - n * n), this.mode) {
                case Zs:
                    a.y = Math.asin(o * this.sinph0 + t.y * n * this.cosph0 / r), t.y = (o - this.sinph0 * Math.sin(a.y)) * r, t.x *= n * this.cosph0;
                    break;
                case Vs:
                    a.y = Math.asin(t.y * n / r), t.y = o * r, t.x *= n;
                    break;
                case Js:
                    a.y = Math.asin(o), t.y = -t.y;
                    break;
                case Xs:
                    a.y = -Math.asin(o)
            }
...
const ti = {
    ...
    forward: function(t) {
        var e, s, i, a, r = t.x,
            o = t.y;
        if (r -= this.long0, "ellipse" === this.shape) {
            o = Math.atan(this.radius_p2 * Math.tan(o));
            var n = this.radius_p / ke(this.radius_p * Math.cos(o), Math.sin(o));
            if (s = n * Math.cos(r) * Math.cos(o), i = n * Math.sin(r) * Math.cos(o), a = n * Math.sin(o), (this.radius_g - s) * s - i * i - a * a * this.radius_p_inv2 < 0) return t.x = Number.NaN, t.y = Number.NaN, t;
            e = this.radius_g - s, this.flip_axis ? (t.x = this.radius_g_1 * Math.atan(i / ke(a, e)), t.y = this.radius_g_1 * Math.atan(a / e)) : (t.x = this.radius_g_1 * Math.atan(i / e), t.y = this.radius_g_1 * Math.atan(a / ke(i, e)))
        } else "sphere" === this.shape && (e = Math.cos(o), s = Math.cos(r) * e, i = Math.sin(r) * e, a = Math.sin(o), e = this.radius_g - s, this.flip_axis ? (t.x = this.radius_g_1 * Math.atan(i / ke(a, e)), t.y = this.radius_g_1 * Math.atan(a / e)) : (t.x = this.radius_g_1 * Math.atan(i / e), t.y = this.radius_g_1 * Math.atan(a / ke(i, e))));
    ...
    inverse: function(t) {
        ...
        if (t.x = t.x / this.a, t.y = t.y / this.a, "ellipse" === this.shape) {
            this.flip_axis ? (n = Math.tan(t.y / this.radius_g_1), o = Math.tan(t.x / this.radius_g_1) * ke(1, n)) : (o = Math.tan(t.x / this.radius_g_1), n = Math.tan(t.y / this.radius_g_1) * ke(1, o));
            var h = n / this.radius_p;
            if (e = o * o + h * h + r * r, (i = (s = 2 * this.radius_g * r) * s - 4 * e * this.C) < 0) return t.x = Number.NaN, t.y = Number.NaN, t;
            a = (-s - Math.sqrt(i)) / (2 * e), r = this.radius_g + a * r, o *= a, n *= a, t.x = Math.atan2(o, r), t.y = Math.atan(n * Math.cos(t.x) / r), t.y = Math.atan(this.radius_p_inv2 * Math.tan(t.y))
        } else if ("sphere" === this.shape) {
            if (this.flip_axis ? (n = Math.tan(t.y / this.radius_g_1), o = Math.tan(t.x / this.radius_g_1) * Math.sqrt(1 + n * n)) : (o = Math.tan(t.x / this.radius_g_1), n = Math.tan(t.y / this.radius_g_1) * Math.sqrt(1 + o * o)), e = o * o + n * n + r * r, (i = (s = 2 * this.radius_g * r) * s - 4 * e * this.C) < 0) return t.x = Number.NaN, t.y = Number.NaN, t;
            a = (-s - Math.sqrt(i)) / (2 * e), r = this.radius_g + a * r, o *= a, n *= a, t.x = Math.atan2(o, r), t.y = Math.atan(n * Math.cos(t.x) / r)
        }
...
const oi = {
    ...
    forward: function(t) {
        var e = pt(t.x - this.long0),
            s = t.y,
            i = Math.asin(ri * Math.sin(s)),
            a = i * i,
            r = a * a * a;
        return t.x = e * Math.cos(i) / (ri * (ei + 3 * si * a + r * (7 * ii + 9 * ai * a))), t.y = i * (ei + si * a + r * (ii + ai * a)), t.x = this.a * t.x + this.x0, t.y = this.a * t.y + this.y0, t
    },
    inverse: function(t) {
        t.x = (t.x - this.x0) / this.a, t.y = (t.y - this.y0) / this.a;
        var e, s, i, a, r = t.y;
        for (a = 0; a < 12 && (r -= i = (r * (ei + si * (e = r * r) + (s = e * e * e) * (ii + ai * e)) - t.y) / (ei + 3 * si * e + s * (7 * ii + 9 * ai * e)), !(Math.abs(i) < 1e-9)); ++a);
        return s = (e = r * r) * e * e, t.x = ri * t.x * (ei + 3 * si * e + s * (7 * ii + 9 * ai * e)) / Math.cos(r), t.y = Math.asin(Math.sin(r) / ri), t.x = pt(t.x + this.long0), t
    },
...
function hi(t) {
    var e, s, i, a = pt(t.x - (this.long0 || 0)),
        r = t.y;
    return e = this.am1 + this.m1 - Fe(r, s = Math.sin(r), i = Math.cos(r), this.en), s = i * a / (e * Math.sqrt(1 - this.es * s * s)), t.x = e * Math.sin(s), t.y = this.am1 - e * Math.cos(s), t.x = this.a * t.x + (this.x0 || 0), t.y = this.a * t.y + (this.y0 || 0), t
}

function li(t) {
    var e, s, i, a;
    if (t.x = (t.x - (this.x0 || 0)) / this.a, t.y = (t.y - (this.y0 || 0)) / this.a, s = ke(t.x, t.y = this.am1 - t.y), a = Ce(this.am1 + this.m1 - s, this.es, this.en), (e = Math.abs(a)) < E) e = Math.sin(a), i = s * Math.atan2(t.x, t.y) * Math.sqrt(1 - this.es * e * e) / Math.cos(a);
    else {
        if (!(Math.abs(e - E) <= ni)) throw new Error;
        i = 0
    }
    return t.x = pt(i + (this.long0 || 0)), t.y = is(a), t
}

function ui(t) {
    var e, s, i = pt(t.x - (this.long0 || 0)),
        a = t.y;
    return s = this.cphi1 + this.phi1 - a, Math.abs(s) > ni ? (t.x = s * Math.sin(e = i * Math.cos(a) / s), t.y = this.cphi1 - s * Math.cos(e)) : t.x = t.y = 0, t.x = this.a * t.x + (this.x0 || 0), t.y = this.a * t.y + (this.y0 || 0), t
}

function ci(t) {
    var e, s;
    t.x = (t.x - (this.x0 || 0)) / this.a, t.y = (t.y - (this.y0 || 0)) / this.a;
    var i = ke(t.x, t.y = this.cphi1 - t.y);
    if (s = this.cphi1 + this.phi1 - i, Math.abs(s) > E) throw new Error;
    return e = Math.abs(Math.abs(s) - E) <= ni ? 0 : i * Math.atan2(t.x, t.y) / Math.cos(s), t.x = pt(e + (this.long0 || 0)), t.y = is(s), t
}
const yi = {
    init: function() {
        var t;
        if (this.phi1 = this.lat1, Math.abs(this.phi1) < ni) throw new Error;
        this.es ? (this.en = Ne(this.es), this.m1 = Fe(this.phi1, this.am1 = Math.sin(this.phi1), t = Math.cos(this.phi1), this.en), this.am1 = t / (Math.sqrt(1 - this.es * this.am1 * this.am1) * this.am1), this.inverse = li, this.forward = hi) : (Math.abs(this.phi1) + ni >= E ? this.cphi1 = 0 : this.cphi1 = 1 / Math.tan(this.phi1), this.inverse = ci, this.forward = ui)
    },
    names: ["bonne", "Bonne (Werner lat_1=90)"]
};
const pi = Object.assign((function(t, e, s) {
    var i, a, r, o = !1;
    return void 0 === e ? (a = Zt(t), i = Xt, o = !0) : (void 0 !== e.x || Array.isArray(e)) && (s = e, a = Zt(t), i = Xt, o = !0), i || (i = Zt(t)), a || (a = Zt(e)), s ? Vt(i, a, s) : (r = {
    ...
    toPoint: Kt,
    defs: nt,
    nadgrid: function(t, e, s) {
        return e instanceof ArrayBuffer ? function(t, e, s) {
            var i = !0;
            void 0 !== s && !1 === s.includeErrorFields && (i = !1);
            var a = new DataView(e),
                r = function(t) {
                    var e = t.getInt32(8, !1);
                    if (11 === e) return !1;
                    e = t.getInt32(8, !0), 11 !== e && console.warn("Failed to detect nadgrid endian-ness, defaulting to little-endian");
                    return !0
                }(a),
                o = function(t, e) {
                    return {
                ...
                n = function(t, e, s, i) {
                    for (var a = 176, r = [], o = 0; o < e.nSubgrids; o++) {
                        var n = kt(t, a, s),
                            h = Tt(t, a, n, s, i),
                            l = Math.round(1 + (n.upperLongitude - n.lowerLongitude) / n.longitudeInterval),
                            u = Math.round(1 + (n.upperLatitude - n.lowerLatitude) / n.latitudeInterval);
                        r.push({
                        ...
                        var c = 16;
                        !1 === i && (c = 8), a += 176 + n.gridNodeCount * c
                    }
                    return r
                }(a, o, r, i),
                h = {
...
var di;
(di = pi).Proj.projections.add(Re), di.Proj.projections.add(qe), di.Proj.projections.add(Be), di.Proj.projections.add(ze), di.Proj.projections.add(We), di.Proj.projections.add(Ke), di.Proj.projections.add(Je), di.Proj.projections.add(Xe), di.Proj.projections.add(Ve), di.Proj.projections.add(rs), di.Proj.projections.add(ps), di.Proj.projections.add(gs), di.Proj.projections.add(ms), di.Proj.projections.add(_s), di.Proj.projections.add(fs), di.Proj.projections.add(Ms), di.Proj.projections.add(ws), di.Proj.projections.add(Ps), di.Proj.projections.add(Es), di.Proj.projections.add(vs), di.Proj.projections.add(Ss), di.Proj.projections.add(xs), di.Proj.projections.add(Gs), di.Proj.projections.add(bs), di.Proj.projections.add(Ls), di.Proj.projections.add(Ks), di.Proj.projections.add(Qs), di.Proj.projections.add($s), di.Proj.projections.add(ti), di.Proj.projections.add(oi), di.Proj.projections.add(yi);
...
var mi, _i, fi, Mi, wi, Pi = {},
    Ei = {},
    vi = {};

function Si() {
    if (_i) return Ei;
    _i = 1, Object.defineProperty(Ei, "__esModule", {
        value: !0
    });
    var t = (mi || (mi = 1, function(t) {
        function e(t, e, s) {
            void 0 === s && (s = {});
            var i = {
                type: "Feature"
        ...
        function s(t, s, i) {
            ...
            if (!y(t[0]) || !y(t[1])) throw new Error("coordinates must contain numbers");
            return e({
                type: "Point",
                coordinates: t
            }, s, i)
        ...
        function i(t, s, i) {
            ...
            for (var a = 0, r = t; a < r.length; a++) {
                ...
                for (var n = 0; n < o[o.length - 1].length; n++)
                    if (o[o.length - 1][n] !== o[0][n]) throw new Error("First and last Position are not equivalent.")
            }
            return e({
                type: "Polygon",
                coordinates: t
        ...
        function r(t, e) {
            ...
            return e.id && (s.id = e.id), e.bbox && (s.bbox = e.bbox), s.features = t, s
        }
        ...
        function l(e, s) {
            void 0 === s && (s = "kilometers");
            var i = t.factors[s];
            if (!i) throw new Error(s + " units is invalid");
            return e * i
        }
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.earthRadius = 6371008.8, t.factors = {
            ...
            millimetres: 1e6,
            yards: 1.195990046
        }, t.feature = e, t.geometry = function(t, e, r) {
            switch (t) {
                case "Point":
                    return s(e).geometry;
                case "LineString":
        ...
        }, t.point = s, t.points = function(t, e, i) {
            return void 0 === i && (i = {}), r(t.map((function(t) {
                return s(t, e)
            })), i)
        }, t.polygon = i, t.polygons = function(t, e, s) {
            return void 0 === s && (s = {}), r(t.map((function(t) {
                return i(t, e)
            })), s)
        }, t.lineString = a, t.lineStrings = function(t, e, s) {
            return void 0 === s && (s = {}), r(t.map((function(t) {
                return a(t, e)
            })), s)
        }, t.featureCollection = r, t.multiLineString = o, t.multiPoint = n, t.multiPolygon = h, t.geometryCollection = function(t, s, i) {
            return void 0 === i && (i = {}), e({
            ...
            var s = Math.pow(10, e || 0);
            return Math.round(t * s) / s
        }, t.radiansToLength = l, t.lengthToRadians = u, t.lengthToDegrees = function(t, e) {
            return c(u(t, e))
        }, t.bearingToAzimuth = function(t) {
            var e = t % 360;
            return e < 0 && (e += 360), e
        }, t.radiansToDegrees = c, t.degreesToRadians = function(t) {
            return t % 360 * Math.PI / 180
        }, t.convertLength = function(t, e, s) {
            if (void 0 === e && (e = "kilometers"), void 0 === s && (s = "kilometers"), !(t >= 0)) throw new Error("length must be a positive number");
            return l(u(t, e), s)
        }, t.convertArea = function(e, s, i) {
            if (void 0 === s && (s = "meters"), void 0 === i && (i = "kilometers"), !(e >= 0)) throw new Error("area must be a positive number");
            var a = t.areaFactors[s];
            if (!a) throw new Error("invalid original units");
            var r = t.areaFactors[i];
            if (!r) throw new Error("invalid final units");
            return e / a * r
        }, t.isNumber = y, t.isObject = function(t) {
            ...
            t.forEach((function(t) {
                if (!y(t)) throw new Error("bbox must only contain numbers")
            }))
    ...
    }, Ei.getCoords = function(t) {
        if (Array.isArray(t)) return t;
        if ("Feature" === t.type) {
            if (null !== t.geometry) return t.geometry.coordinates
        } else if (t.coordinates) return t.coordinates;
        throw new Error("coords must be GeoJSON Feature, Geometry Object or an Array")
    }, Ei.containsNumber = function e(s) {
        if (s.length > 1 && t.isNumber(s[0]) && t.isNumber(s[1])) return !0;
        if (Array.isArray(s[0]) && s[0].length) return e(s[0]);
        throw new Error("coordinates must only contain numbers")
    }, Ei.geojsonType = function(t, e, s) {
        if (!e || !s) throw new Error("type and name required");
        if (!t || t.type !== e) throw new Error("Invalid input to " + s + ": must be a " + e + ", given " + t.type)
    }, Ei.featureOf = function(t, e, s) {
        if (!t) throw new Error("No feature passed");
        if (!s) throw new Error(".featureOf() requires a name");
        if (!t || "Feature" !== t.type || !t.geometry) throw new Error("Invalid input to " + s + ", Feature with geometry required");
        if (!t.geometry || t.geometry.type !== e) throw new Error("Invalid input to " + s + ": must be a " + e + ", given " + t.geometry.type)
    }, Ei.collectionOf = function(t, e, s) {
        if (!t) throw new Error("No featureCollection passed");
        if (!s) throw new Error(".collectionOf() requires a name");
        if (!t || "FeatureCollection" !== t.type) throw new Error("Invalid input to " + s + ", FeatureCollection required");
        for (var i = 0, a = t.features; i < a.length; i++) {
            var r = a[i];
            if (!r || "Feature" !== r.type || !r.geometry) throw new Error("Invalid input to " + s + ", Feature with geometry required");
            if (!r.geometry || r.geometry.type !== e) throw new Error("Invalid input to " + s + ": must be a " + e + ", given " + r.geometry.type)
        }
    }, Ei.getGeom = function(t) {
        return "Feature" === t.type ? t.geometry : t
    }, Ei.getType = function(t, e) {
...
var xi = y.exports = (Mi = h(gi), wi = function() {
    if (fi) return Pi;
    fi = 1, Object.defineProperty(Pi, "__esModule", {
        value: !0
    });
    var t = Si();
    ...
    function e(t, e, s) {
        ...
        for (var a = 0, r = e.length - 1; a < e.length; r = a++) {
            var o = e[a][0],
                n = e[a][1],
                h = e[r][0],
                l = e[r][1];
            if (t[1] * (o - h) + n * (h - t[0]) + l * (t[0] - o) == 0 && (o - t[0]) * (h - t[0]) <= 0 && (n - t[1]) * (l - t[1]) <= 0) return !s;
            n > t[1] != l > t[1] && t[0] < (h - o) * (t[1] - n) / (l - n) + o && (i = !i)
        }
        return i
    }
    return Pi.default = function(s, i, a) {
        if (void 0 === a && (a = {}), !s) throw new Error("point is required");
        ...
        for (var u = !1, c = 0; c < l.length && !u; c++)
            if (e(r, l[c][0], a.ignoreBoundary)) {
                for (var y = !1, p = 1; p < l[c].length && !y;) e(r, l[c][p], !a.ignoreBoundary) && (y = !0), p++;
                y || (u = !0)
            }
        return u
    }, Pi
                ...
                const y = u.features.reduce(((t, e) => (t[e.id] = e, t)), {}),
                    ...
                    g = t => {
                        ...
                        if ("FeatureCollection" === e) {
                            ...
                            return {
                                lat: {
                                    min: Math.min(...t.map((t => t.lat.min))),
                                    max: Math.max(...t.map((t => t.lat.max)))
                                },
                                lng: {
                                    min: Math.min(...t.map((t => t.lng.min))),
                                    max: Math.max(...t.map((t => t.lng.max)))
                                }
                            }
                        }
                        if ("Feature" == e) return g(i);
                        if ("MultiPolygon" === e) return g({
                            type: "Polygon",
                            coordinates: a.flat()
                        });
                        if ("Polygon" == e) {
                        ...
                        throw new Error(`Unknown geojson type ${e}`)
                    },
                    m = ({
                        height: t = 0,
                        width: e = 0,
                        ...
                        if (t <= 0 && e <= 0) throw new Error("height or width is required");
                        let r = u;
                        s.length > 0 ? (r = {
                            type: "FeatureCollection",
                            features: s.map((t => y[t]))
                        }, i || (i = g(r))) : i || (i = d);
                        const o = {
                                type: "Feature",
                                geometry: {
                                    type: "MultiPolygon",
                                    coordinates: r.features.reduce(((t, e) => t.concat("Polygon" === e.geometry.type ? [e.geometry.coordinates] : e.geometry.coordinates)), [])
                                }
                            },
                            [h, c] = n()(n().defs("GOOGLE"), [i.lng.min, i.lat.min]),
                            [p, m] = n()(n().defs("GOOGLE"), [i.lng.max, i.lat.max]),
                            _ = p - h,
                            f = m - c;
                        e <= 0 ? e = Math.round(t * _ / f) : t <= 0 && (t = Math.round(e * f / _));
                        const M = {},
                            w = "diagonal" === a ? Math.sqrt(3) / 2 : 1;
                        for (let u = 0; u * w < t; u += 1)
                            for (let s = 0; s < e; s += 1) {
                                const i = u % 2 == 0 && "diagonal" === a ? s + .5 : s,
                                    r = u * w,
                                    c = [i / e * _ + h, m - r / t * f],
                                    y = n()(n().defs("GOOGLE"), n().defs("WGS84"), c);
                                l()(y, o) && (M[[s, u].join(";")] = {
                                    x: i,
                                    y: r
                                })
                    ...
                    f = function(t) {
                        var e = t,
                            ...
                            o = ((t, e) => {
                                var s = {};
                                for (var o in t) a.call(t, o) && e.indexOf(o) < 0 && (s[o] = t[o]);
                                if (null != t && i)
                                    for (var o of i(t)) e.indexOf(o) < 0 && r.call(t, o) && (s[o] = t[o]);
                                return s
                            })(e, ["avoidOuterPins"]);
                        const n = (({
                                height: t = 0,
                                ...
                                region: i,
                                grid: a = "vertical"
                            }) => [JSON.stringify(i), a, t, e, JSON.stringify(s)].join(" "))(o),
                            h = p[n] || m(o);
                ...
                const p = function({
                    ...
                    return {
                        addPin({
                            ...
                            const c = ((t, i) => e(t, s(i)))(((t, e) => {
                                for (var s in e || (e = {})) a.call(e, s) && o(t, s, e[s]);
                                if (i)
                                    for (var s of i(e)) r.call(e, s) && o(t, s, e[s]);
                                return t
                            })({}, this.getPin({
                                lat: t,
                                lng: n
                            ...
                            return h[[c.x, c.y].join(";")] = c, c
                        },
                        getPin({
                            lat: t,
                            lng: e
                        }) {
                            const [s, i] = u()(u().defs("GOOGLE"), [e, t]);
                            if (n) {
                                const t = u()(u().defs("GOOGLE"), u().defs("WGS84"), [s, i]);
                                if (!y()(t, poly)) return
                            }
                            let [a, r] = [_ * (s - l) / p, f * (c - i) / d];
                            const o = Math.round(r / M);
                            o % 2 == 0 && "diagonal" === m && (a -= .5);
                            const h = Math.round(a);
                            let [g, w] = [h, Math.round(o) * M];
                            o % 2 == 0 && "diagonal" === m && (g += .5);
                            const [P, E] = u()(u().defs("GOOGLE"), u().defs("WGS84"), [g * p / _ + l, c - w * d / f]);
                            return {
                                x: g,
                                y: w,
                                lat: E,
                        ...
                        getPoints: () => Object.values(h),
                        getSVG: ({
                            shape: t = "circle",
                            color: e = "current",
                            backgroundColor: s = "transparent",
                            radius: i = .5
                        }) => `<svg viewBox="0 0 ${_} ${f}" xmlns="http://www.w3.org/2000/svg" style="background-color: ${s}">\n        ${Object.values(h).map((({x:s,y:a,svgOptions:r={}})=>{const o=r.radius||i;if("circle"===t)return` < circle cx = "${s}"
                        cy = "${a}"
                        r = "${o}"
                        fill = "${r.color||e}" / > `;if("hexagon"===t){const t=Math.sqrt(3)*o;return` < polyline points = "${[[s+t,a-o],[s+t,a+o],[s,a+2*o],[s-t,a+o],[s-t,a-o],[s,a-2*o]].map((t=>t.join(",
                        "))).join("
                        ")}"
                        fill = "${r.color||e}" / > `}})).join("\n")}\n      </svg>`,
                        image: {
    ...
    function h(e) {
        ...
        return t[e](i, i.exports, h), i.exports
    }
    return h.n = t => {
        ...
        for (var s in e) h.o(e, s) && !h.o(t, s) && Object.defineProperty(t, s, {
            enumerable: !0,
            get: e[s]
        })
